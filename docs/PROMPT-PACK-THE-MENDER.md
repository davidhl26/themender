...
## @SamSDF — le déguisement, capuche tirée devant, écharpe sur la bouche, UNE BANDE DE PEAU qui transparaît aux yeux ⟵ *(fiche @Sam en référence — AUCUNE barbe postiche)*
> **GÉNÉRÉE LE 14/09 (v4, bande de peau aux yeux) — job `87baf143-a1aa-496f-8077-793847174644`** *(GPT Image 2 · 4K · high · 16:9 · référence = la fiche @samafter, job `9e1cebfd-0c0f-46b3-85de-748bc35d0200`)*. **À sauvegarder comme Élément `@samsdf`** après avoir supprimé sur le compte les deux versions précédentes du même jour : `samsdf` (visage découvert, job `6e4fb30e-eb6e-408f-937c-4d9e312dd29f`) et `samsdf-1` (capuche sans écharpe, job `7696c5ab-6874-4168-8d58-c9cd3b7e86c4`). Deux versions intermédiaires n'ont pas été enregistrées : « écharpe sous la barbe » (job `e3242c44-de40-4c53-b4bd-8dc5cb5ebe10`) et « capuche + écharpe, visage entièrement noir » (job `4a7736f1-13a7-43d8-affc-8aad54d72794` — David : on dirait un bonnet sur le visage, il faut que la peau transparaisse).
*Le SDF porte la vraie barbe de Sam, salie et hérissée — on n'en voit que des mèches qui dépassent de la laine. Le déguisement : bonnet, capuche tirée loin devant, crasse, couches, posture, et **une écharpe de laine gris anthracite remontée sur le menton, la bouche et le nez** : entre le bord de la capuche et le bord de l'écharpe, **une étroite bande de peau dans l'ombre — le front, l'arête du nez, deux reflets pour les yeux — jamais un visage lisible**. En G21 il parle à travers la laine (répliques 1 et 3), la baisse sous le menton pour manger (réplique 2 bouche visible) et la remonte ; en G28 les yeux sortent dans le sodium au-dessus de la laine ; **G32a** (nouveau plan) : il baisse l'écharpe, l'enlève, retire le bonnet — le visage entier pour la première fois ; G32 : le sourire. Pour ces deux derniers plans, le visage vient de `@samafter`, chargé en plus.*

A three-panel character reference sheet of the same heavy grey-bearded man from the reference image, keeping his exact build, his weight and his month-old scruffy salt-and-pepper beard — now living rough, HIS FACE HIDDEN BUT NOT ERASED: the deep hood of a torn olive parka is up and pulled far forward past the brow, the head bowed a few degrees, so that the inside of the hood is deep shadow; a stretched dark grey wool beanie sits HIGH on the head under the hood, its edge just showing above the eyebrows and NEVER pulled down over the eyes; and A SCARF COVERS THE LOWER FACE: a coarse dark charcoal-grey wool scarf, pilled, frayed at the ends, wound twice around the neck and the lower face and pulled up over the chin, the mouth and the nose to the bridge of the nose, knotted at the side of the neck. Between the hood's edge above and the scarf's edge below A NARROW BAND OF BARE SKIN SHOWS DIMLY THROUGH THE SHADOW — the brow, the tops of the cheekbones, the bridge of the nose, the two eyes sunk in the dark of the hood and readable only as two faint glints: enough to see that a living man is in there, never enough to know who. No mouth, no chin, no lips; the beard only as a few grey strands of matted hair escaping around the scarf's edges at the jaw and the cheeks; a grey film of grime on the strip of neck below the scarf. NOT a balaclava, NOT a black void, NOT a mask, NOT a beanie pulled over the face. Evenly spaced left to right, separated by thin vertical dividers, on a plain mid-grey seamless studio background.
Panel one, left: a headless full-body front view. The body stands straight, arms relaxed at the sides, feet shoulder width apart. There is no head and no neck, the coil of the dark grey scarf holds its own shape around an empty dark hollow above the layered flannel collars, the parka's empty hood hanging back against the shoulders, as if an invisible person is wearing it all. The scarf's upper edge is crisp and complete. No fade, no blur, no ghosting, no stump, no wound.
Panel two, centre: the same body full length seen from directly behind, standing straight, arms relaxed at the sides, the hood UP and covering the whole head so that no hair and no beanie show from behind, the scarf's coil visible at the nape below the hood's edge, facing away from camera.
Panel three, right: the same man chest-up, front on, the hood up and pulled far forward, the head bowed a few degrees, the dark grey scarf covering the nose, the mouth and the chin, the parka open over it — and in the shadow of the hood the narrow band of skin at the eyes shows dimly, the brow and the bridge of the nose catching a little light, the eyes two faint glints, the beanie's edge just above the brow; nothing else of the face; grey beard strands escaping at the scarf's edges.
...
Wardrobe, identical in all three panels: a filthy oatmeal thermal shirt under two open flannel shirts in faded brown and washed-out blue check, the dark charcoal-grey wool scarf wound twice at the neck and over the lower face, over them a torn olive parka with a deep hood, the stuffing showing at the left shoulder and no zip, baggy stained dark trousers held with a length of rope, mismatched boots, one taped at the toe.
Flat even studio lighting, shadowless, no cast shadows on the background, identical lighting across all three panels; the inside of the hood stays in shadow under this flat light because the hood is pulled far forward, yet the skin at the eyes still reads faintly through it. Photographic, shot on a real camera, sharp focus, visible skin pores and fabric weave, no CGI. No red anywhere in the wardrobe, the scarf is dark grey and never red. Original character, not resembling any real person or any celebrity. No text, no watermark, no logos.
...
> **GÉNÉRÉE LE 14/09 — job `56415cca-5183-4064-9ad7-3d94d93c7d13`** *(GPT Image 2 · 4K · high · 16:9 · référence = la fiche @maeva, job `f481951a-ea65-4c9b-9b0a-44382bc06809`)*. Sauvegardée comme Élément **`@maeveill`**. À valider à l'œil : le même visage que @maeva, amaigri ; l'écharpe est le seul rouge.
...
### LES GENS DU PORT — huit figurants Éléments *(générés et enregistrés le 14/09)*
*Demande de David : « beaucoup de monde qui travaille sur le port, même fond, parce que ce seront des Éléments ». Huit fiches à trois panneaux sur **le même fond gris moyen sans couture**, gabarit identique à celui du haut du pack (panneau 1 sans tête, panneau 2 de dos avec la tête, panneau 3 buste de face), GPT Image 2 · 4K · high · 16:9, **aucune image de référence** (visages indépendants, aucun ne ressemble à un personnage du film), **aucun rouge** (le gilet de la grutière est jaune, jamais orange). Chaque fiche est déjà un Élément sur le compte, catégorie personnage.*

| Élément | Rôle | Qui | Job |
|---|---|---|---|
| `@port-docker` | docker | Cap-Verdien américain, 55 ans, bonnet marine, salopette cirée ocre, bottes de mer noires | `54f05a63-81ca-41df-adf2-cdb8d73a8872` |
| `@port-fisherman` | pêcheur | Portugais des Açores, 62 ans, ciré olive, pull de marin crème, bottes vertes | `6c015627-506b-4be8-9a3a-3b242703c50e` |
| `@port-fishmonger` | poissonnière | Irlandaise américaine, 46 ans, cardigan gris, tablier blanc en caoutchouc, filet à cheveux | `14a138bb-df3c-4026-ba8c-38ca25cc60cf` |
| `@port-netmender` | ramendeur | Québécois, 76 ans, casquette de tweed, pull brun reprisé, ficelle goudronnée à la ceinture | `f6f4875e-f7dd-4f19-b962-59cb6ee5d61e` |
| `@port-crane` | grutière | Afro-Américaine, 36 ans, gilet haute visibilité jaune, casque blanc à la main | `60f5c8f2-1e54-4d4f-9551-c7197bcea742` |
| `@port-deckhand` | matelot | Guatémaltèque américain, 23 ans, sweat noir à capuche, salopette verte, bottes blanches | `dda75500-5713-4d86-9831-8a630c8a5fc0` |
| `@port-forklift` | cariste | Polonais américain, 41 ans, bonnet gris, veste de travail brune matelassée, clés à la ceinture | `33c94677-6a50-461f-ab0d-9960f2ed299e` |
| `@port-foreman` | contremaîtresse | Yankee de Nouvelle-Angleterre, 58 ans, veste cirée olive, radio au col, casque jaune sous le bras | `a92dd3f1-0101-4a60-ae3d-ea7bec6b07bb` |

**Image de groupe** (14/09, GPT Image 2 · 4K · high · 21:9, les huit Éléments chargés en référence) : les huit debout côte à côte sur une seule rangée, plain-pied, de face, même fond gris et même lumière plate — job `1333ac70-486b-45c6-aaac-bba4e5df38b7`, enregistrée comme Élément `@portworkers` (un seul emplacement de référence pour tout le port). Ordre de gauche à droite : contremaîtresse · docker · poissonnière · pêcheur · ramendeur · grutière · matelot · cariste.

⚠ **Aucun prompt vidéo 2.0 ne les charge encore.** Ils sont là pour peupler le port quand un plan le demande : premier candidat **G03 (le quai, séq. 2)** en silhouettes de fond derrière la famille, puis tout plan de port à venir. À charger comme Éléments dans le prompt du plan concerné, jamais plus de trois ou quatre par prise, et **toujours à distance** — aucun ne doit voler un gros plan à un personnage du film. À valider à l'œil : même gris de fond d'une fiche à l'autre, aucun rouge, aucun logo.
