...
## @SamSDF — le déguisement, VISAGE CACHÉ SOUS LA CAPUCHE ⟵ *(fiche @Sam en référence — AUCUNE barbe postiche)*
> **GÉNÉRÉE LE 14/09 — job `7696c5ab-6874-4168-8d58-c9cd3b7e86c4`** *(GPT Image 2 · 4K · high · 16:9 · référence = la fiche @samafter, job `9e1cebfd-0c0f-46b3-85de-748bc35d0200`)*. Sauvegardée comme Élément **`@samsdf-1`** (le compte portait déjà un `samsdf` : l'ancienne fiche à visage découvert, à supprimer dans l'interface). Une première version à visage découvert (job `6e4fb30e-eb6e-408f-937c-4d9e312dd29f`) a été générée le même jour puis remplacée à la demande de David : **la capuche cache tout au-dessus de la lèvre supérieure**, comme dans chaque plan du film. Pour le démasquage (G28, G32), le visage est fourni par `@samafter`, chargé en plus.
*Le SDF porte la vraie barbe de Sam, salie et hérissée. Le déguisement n'est que bonnet, capuche tirée loin devant, crasse, couches et posture. La fiche ne montre jamais ses yeux.*

A three-panel character reference sheet of the same heavy grey-bearded man from the reference image, keeping his exact build, his weight, his month-old scruffy salt-and-pepper beard and his mouth — now living rough, AND HIS FACE HIDDEN: the deep hood of a torn olive parka is up over a stretched dark grey wool beanie and pulled far forward past the brow, the head bowed a few degrees, so that the inside of the hood is a deep dark cavity and NOTHING ABOVE THE UPPER LIP IS VISIBLE — no eyes, no brow, no nose, no cheekbones, no glint inside the hood. What shows below the hood's edge is only the lower half of the face: the same beard dirtied, matted and made to read fuller and older, wind-cracked lips, the chin, a grey film of grime worked into the beard and the neck. Evenly spaced left to right, separated by thin vertical dividers, on a plain mid-grey seamless studio background.
Panel one, left: a headless full-body front view. The body stands straight, arms relaxed at the sides, feet shoulder width apart. There is no head and no neck, the parka's empty hood hangs back against the shoulders and the layered flannel collars hold their own shape, the opening reading as an empty dark hollow looking down into the shirts, as if an invisible person is wearing it. The collar edge is crisp and complete. No fade, no blur, no ghosting, no stump, no wound.
Panel two, centre: the same body full length seen from directly behind, standing straight, arms relaxed at the sides, the hood UP and covering the whole head so that no hair and no beanie show from behind, facing away from camera.
Panel three, right: the same man chest-up, front on, the hood up and pulled far forward, the head bowed a few degrees, the inside of the hood a dark cavity above the upper lip, only the matted beard, the cracked lips and the chin lit below its edge, mouth closed. No eyes are visible, no nose, no brow.
