...
## @SamSDF — le déguisement, VISAGE CACHÉ SOUS LA CAPUCHE, ÉCHARPE AU COU ⟵ *(fiche @Sam en référence — AUCUNE barbe postiche)*
> **GÉNÉRÉE LE 14/09 — job `e3242c44-de40-4c53-b4bd-8dc5cb5ebe10`** *(GPT Image 2 · 4K · high · 16:9 · référence = la fiche @samafter, job `9e1cebfd-0c0f-46b3-85de-748bc35d0200`)*. **À sauvegarder comme Élément `@samsdf`** après avoir supprimé sur le compte les deux versions précédentes du même jour : `samsdf` (visage découvert, job `6e4fb30e-eb6e-408f-937c-4d9e312dd29f`) et `samsdf-1` (capuche sans écharpe, job `7696c5ab-6874-4168-8d58-c9cd3b7e86c4`).
*Le SDF porte la vraie barbe de Sam, salie et hérissée. Le déguisement n'est que bonnet, capuche tirée loin devant, crasse, couches, posture — et **une écharpe de laine gris anthracite au cou, sous la barbe, jamais sur la bouche** (les trois répliques de G21 restent lisibles sur les lèvres). Elle est portée en G21 et G28 et **enlevée entre G28 et G32** (en vrac sur le banc en G32). La fiche ne montre jamais ses yeux ; pour le démasquage (G28, G32), le visage vient de `@samafter`, chargé en plus.*

A three-panel character reference sheet of the same heavy grey-bearded man from the reference image, keeping his exact build, his weight, his month-old scruffy salt-and-pepper beard and his mouth — now living rough, AND HIS FACE HIDDEN: the deep hood of a torn olive parka is up over a stretched dark grey wool beanie and pulled far forward past the brow, the head bowed a few degrees, so that the inside of the hood is a deep dark cavity and NOTHING ABOVE THE UPPER LIP IS VISIBLE — no eyes, no brow, no nose, no cheekbones, no glint inside the hood. What shows below the hood's edge is only the lower half of the face: the same beard dirtied, matted and made to read fuller and older, wind-cracked lips, the chin, a grey film of grime worked into the beard and the neck. AROUND HIS NECK, A SCARF: a coarse dark charcoal-grey wool scarf, pilled, frayed at the ends, wound twice around the neck and knotted loosely at the front, its folds sitting UNDER the beard so the beard lies over it — it hides the neck and the shirt collars, it NEVER covers the mouth or the beard. Evenly spaced left to right, separated by thin vertical dividers, on a plain mid-grey seamless studio background.
...
Panel three, right: the same man chest-up, front on, the hood up and pulled far forward, the head bowed a few degrees, the inside of the hood a dark cavity above the upper lip, only the matted beard, the cracked lips and the chin lit below its edge, mouth closed, the dark grey scarf wound under the beard and knotted at the front, the parka open over it. No eyes are visible, no nose, no brow.
