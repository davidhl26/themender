...
## @SamSDF — le déguisement, AUCUN VISAGE : capuche tirée devant, écharpe sur la bouche ⟵ *(fiche @Sam en référence — AUCUNE barbe postiche)*
> **GÉNÉRÉE LE 14/09 — job `4a7736f1-13a7-43d8-affc-8aad54d72794`** *(GPT Image 2 · 4K · high · 16:9 · référence = la fiche @samafter, job `9e1cebfd-0c0f-46b3-85de-748bc35d0200`)*. **À sauvegarder comme Élément `@samsdf`** après avoir supprimé sur le compte les deux versions précédentes du même jour : `samsdf` (visage découvert, job `6e4fb30e-eb6e-408f-937c-4d9e312dd29f`) et `samsdf-1` (capuche sans écharpe, job `7696c5ab-6874-4168-8d58-c9cd3b7e86c4`). Une version intermédiaire « écharpe sous la barbe » (job `e3242c44-de40-4c53-b4bd-8dc5cb5ebe10`) n'a pas été enregistrée.
*Le SDF porte la vraie barbe de Sam, salie et hérissée — on n'en voit que des mèches qui dépassent de la laine. Le déguisement : bonnet, capuche tirée loin devant, crasse, couches, posture, et **une écharpe de laine gris anthracite remontée sur le menton, la bouche et le nez** : entre le bord de la capuche et le bord de l'écharpe, **aucun visage**. En G21 il parle à travers la laine (répliques 1 et 3), la baisse sous le menton pour manger (réplique 2 bouche visible) et la remonte ; en G28 les yeux sortent dans le sodium au-dessus de la laine ; **G32a** (nouveau plan) : il baisse l'écharpe, l'enlève, retire le bonnet — le visage entier pour la première fois ; G32 : le sourire. Pour ces deux derniers plans, le visage vient de `@samafter`, chargé en plus.*

A three-panel character reference sheet of the same heavy grey-bearded man from the reference image, keeping his exact build, his weight and his month-old scruffy salt-and-pepper beard — now living rough, AND HIS FACE ENTIRELY HIDDEN: the deep hood of a torn olive parka is up over a stretched dark grey wool beanie and pulled far forward past the brow, the head bowed a few degrees, so that the inside of the hood is a deep dark cavity; and A SCARF COVERS THE LOWER FACE: a coarse dark charcoal-grey wool scarf, pilled, frayed at the ends, wound twice around the neck and the lower face and pulled up over the chin, the mouth and the nose to the bridge of the nose, knotted at the side of the neck. Between the hood's edge above and the scarf's edge below NOTHING OF THE FACE IS VISIBLE — no eyes, no brow, no nose, no mouth, no chin, no glint inside the hood; only a few grey strands of the matted beard escaping around the scarf's edges at the jaw and the cheeks, and a grey film of grime on the strip of neck below the scarf. Evenly spaced left to right, separated by thin vertical dividers, on a plain mid-grey seamless studio background.
...
Panel three, right: the same man chest-up, front on, the hood up and pulled far forward, the head bowed a few degrees, the dark grey scarf covering the nose, the mouth and the chin, the parka open over it — a dark hood cavity above, dark wool below, and no face at all between them; only grey beard strands escaping at the scarf's edges.
...
Flat even studio lighting, shadowless, no cast shadows on the background, identical lighting across all three panels; the cavity of the hood stays dark even under this flat light because the hood is pulled far forward. Photographic, shot on a real camera, sharp focus, visible skin pores and fabric weave, no CGI. No red anywhere in the wardrobe, the scarf is dark grey and never red. Original character, not resembling any real person or any celebrity. No text, no watermark, no logos.
