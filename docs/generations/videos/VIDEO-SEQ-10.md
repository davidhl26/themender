...
> champ est ce qui empêche une ligne d'écriture de devenir lisible. **Durée refusée par le moteur → générer à
> la durée supérieure et couper au point indiqué** sous le bloc.
> **Elements** : **@Nora** (10A → 10F-1 ; elle disparaît du film après 10F-1) · **@SamSDF** *(10F-4 seul)* ·
> **@RedHouseExterior** (LIEU-15) · **@RedHouseInterior v2** · **@BusShelter** (LIEU-14).
...
> **10F-4 : AUCUN**. **Ordre au montage : 10A → 10B → 10C → 10D-1 → 10D-2 → 10E → 10F-1 → 10F-2 → 10F-3 →
> 10F-4**, puis la seconde moitié du document (abribus, montage muet, hôpital, sourire, carton).
> ⚠ Générer DANS LE PROJET FESTIVAL. Un bloc = une génération, collée telle quelle, sans en retirer une ligne.
>
> ⚠ **CINQ ÉCARTS DÉCLARÉS** · **10A** : LIEU-15 dit « a true paraffin flame » — ici **une ampoule
> électrique**, fixe : c'est elle qui charge les murs (règle H) · **10C shot 2** : pas de start frame, la porte
> vue de l'intérieur et son interrupteur bakélite n'existent dans aucune image de lieu · **10D-1** : pas de
> start frame, le bloc doit démarrer sur du noir plein · **10E** : pas de start frame, l'IMAGE C est une vue
> d'ensemble, **ce n'est pas ce cadre** · **10F-4** : pas de start frame ; **LIEU-14 IMAGE 3 est la CIBLE de
> la dernière image**, jamais son départ.
>
> ⚠ **VERROUS** · **RÈGLE ZÉRO** : elle ne comprend rien, ne soupçonne rien, ne cherche personne — en 10C elle
> **sourit sans savoir pourquoi et elle passe**, en 10E elle pleure et sourit **de ce qu'elle voit** ; aucun
> nom, aucune question, aucun regard qui doute, à aucune image. · **RÈGLE B** : **10A est le premier rouge
> plein cadre du film**, et **le rouge ne sort jamais de cette maison** — en 10F-1/10F-2 la lueur s'arrête net
> à la pierre du seuil. · **RÈGLE G** : aucune ligne lisible — **texture cursive qui ne forme AUCUN
> caractère** ; **le dragon est un artwork [POST]**, la plage de plâtre de 10C est générée **VIDE** ; filet :
> une image qui laisse lire un mot → surface reprise en post. · **RÈGLE H** : **c'est de la peinture** — pots,
> pinceaux, escabeau, matelas dans le cadre **AVANT** la lueur et après ; **l'ampoule chargeait les murs**, et
> **c'est Nora qui l'éteint** (10C shot 2). · **AUCUN DIALOGUE** avant 10.10 ; **AUCUN SOUS-TITRE** — chaque
> NEGATIVE PROMPT porte *subtitles, captions, burned-in text, karaoke lyrics* et *frozen characters,
> statue-like stillness, mannequin pose, freeze-frame stillness*.

---

## STORYBOARD — LA PLANCHE DE PRÉVISUALISATION *(skill motion-design · à générer AVANT les vidéos)*

> UNE image GPT Image 2 (4K · 16:9, masters de lieux en référence) = toutes les vignettes, validées pour ~12
> crédits AVANT les crédits vidéo. ⚠ Outil de travail, jamais au montage ; chaque vignette = la DERNIÈRE image
> de sa génération. ⚠ Elle couvre **toute la séquence 10, fin comprise** (vignettes 8-12 = seconde moitié).

```
Storyboard sheet with 12 sequential panels in a clean grid, thin white borders, each panel labeled only with its shot code (10.1 to 10.12) underneath. Cinematic live-action previsualization, consistent face, wardrobe and locations across all panels; desaturated grey-blue underexposed world EXCEPT inside the red house. 10.1: a grey street at night, one small dark red house at the far end, a warm bulb behind its window, a fifteen-year-old girl small and from behind. 10.2: the written room, the girl from behind mid-turn under a bare hanging bulb, walls covered skirting-to-shoulder in dense dark red cursive strokes, empty paint pots, hardened brushes, a folded stepladder, a bare mattress. 10.3: the girl in profile stopped dead at arm's reach from a wall, eyes on one clear empty patch of bare plaster, a smile beginning. 10.4: her hand on an old round bakelite switch by the front door. 10.5: the same room in pitch dark lit only by the writing glowing faintly like embers under ash, walls and whole ceiling, the girl a dark shape in the middle. 10.6: her face very close, lit only by that dim red, mouth open, one tear, smiling. 10.7: a very high night view of an underexposed city, sodium lamps as orange grains, one bus shelter's lit island far below. 10.8: a homeless man on the bench under sodium, head lifted, EYES VISIBLE, half a wrapped sandwich in his hand, fingers stained dark to the second knuckle. 10.9: a dark hallway, a man a metre from an ajar bedroom door, his hand lifted and not touching it. 10.10: a hospital room, a dying woman's two hands holding a man's face. 10.11: the same man on the bench, face tilted up to the sky, eyes wet, smiling. 10.12: a completely black frame. No logos, no other text beyond the shot codes. No red anywhere except the house in 10.1 and the room in 10.2 to 10.6. No legible handwriting: the writing is a dense abstract cursive texture forming no characters in any language. No face of any coated figure. Hyper-realistic cinematic film stills, true-to-life colour, film grain — NOT motion graphics, NOT illustration, NOT concept art, no CGI look. Natural depth of field, halation around practical sources, faint shadow noise, film-like highlight roll-off; no oversharpening, no waxy skin, no teal-and-orange grade, no AI artifacts.
```
...
> ⚠ **BLOC DÉDIÉ.** Première des deux seules fois où les yeux de Sam existent (l'autre est 10L).
> **Charger les DEUX fiches** : @SamSDF le corps et la crasse, @Sam le visage et les yeux. **Nora
> n'est dans aucun cadre d'ici au noir final.** ⚠ **ÉCART DÉCLARÉ** : LIEU-14 pose la lampe au-dessus
> du banc, ici au-dessus **et légèrement DEVANT** (mât hors cadre, même écart en 10L).
...
> ⚠ **DEUX PASSES** : **A = shots 1-2** *(8 s, start frame ci-dessus)* · **B = shots 3-4** *(6 s, sans
> start frame)* ; on ne retire que les shots de l'autre passe dans le FRAME MAP.
> ⚠ **VERROU : aucun morceau du visage de Sam au-dessus de la lèvre n'existe dans ce bloc.**
> ⚠ **RÈGLE ZÉRO (sh.1)** : un seul frame où Nora a l'air d'entendre quelqu'un derrière le battant →
> **refaire.** ⚠ **RÈGLE D** : manteau et visage ne cohabitent dans aucune image. ⚠ **LES MAINS** :
> propres au sh.1 *(c'est la cause)*, encrées aux sh.2-3 — c'est le plant que 10H encaisse.
> ⚠ **h termine le montage** : il vient de terroriser sa fille et il ne se retourne pas.
...
> ⚠ **DEUX PASSES OBLIGATOIRES** : **A = shots 1-2** *(la maison rouge, 9 s, 28 mm)* · **B = shots
> 3-5** *(les complices et l'effacement, 10 s, 50 mm)*. ⚠ **DEUX ÉTATS DU MÊME DÉCOR À DES MOIS
> D'INTERVALLE** (sh.1 plâtre nu / sh.2 pièce finie) : c'est ce qui casse en premier ; murs à moitié
> écrits au sh.2 → **scinder en deux générations d'un shot**. ⚠ **RÈGLE H** : la lueur est **de la
> peinture** chargée par l'ampoule — pots vides, pinceaux durcis, escabeau et matelas sont dans le
> cadre AVANT la lueur, et c'est LUI qui éteint. ⚠ **d et e : elles HOCHENT LA TÊTE, elles ne rient
> pas.** ⚠ **RÈGLE C** : rien de ce qu'il demande n'est lisible ni audible. ⚠ **RÈGLE D (sh.5)** : le
> manteau passe physiquement devant son visage au moment où il l'arrache.
...
> ⚠ **CE BLOC REMPLACE LE BLOC 3D DE `VIDEO-SEQ-03.md` : UNE GÉNÉRATION POUR DEUX PLANS.** Le fichier
> sert en **3.5** (la vitre étouffe tout) et en **10.10** (le son de la chambre entre pour la première
> fois). **Générer les répliques ICI, avec le son** — seule façon d'avoir un vrai lip-sync ; conserver
> le master non réencodé et **corriger `VIDEO-SEQ-03.md` §3D**, qui interdisait encore la voix.
> ⚠ **RÈGLE A** : ces deux répliques portent **la seule occurrence du mot interdit depuis l'acte I**,
> recopiées mot pour mot. ⚠ **RÈGLE F** : sa voix à lui s'arrête sur ce plan.
...
> ⚠ **BLOC DÉDIÉ, JAMAIS GROUPÉ. Charger les DEUX fiches** : @SamSDF le corps et la crasse, @Sam le
> visage et les yeux. Seconde et dernière fois du film où ses yeux existent.
> ⚠ **LAMPE LÉGÈREMENT DEVANT LUI** — sinon les orbites restent noires et le plan ne vaut rien.
> ⚠ **AUCUNE BARBE POSTICHE, RIEN NE S'ARRACHE.** ⚠ **IL NE SOURIT PAS À SA FILLE, IL SOURIT À SA
> FEMME** : il lève les yeux et il lui dit qu'il l'a fait. Nora est partie — c'est ce qui tient la
> RÈGLE ZÉRO jusqu'au noir.
