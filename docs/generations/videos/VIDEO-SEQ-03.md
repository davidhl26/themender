...
> **Start frames** : 3A — aucune (insert au comptoir, l'Élément @Kitchen porte le décor) · **LIEU-05 IMAGE 2** → 3B · **LIEU-04 IMAGE 2** → 3C · **LIEU-04 IMAGE 2** → 3D (shots 2 et 3 après hard cut interne, sans start frame) · **LIEU-05 IMAGE 3** → 3E *(⚠ à générer avec le plus grand soin — le cadre est rejoué tel quel en 10.10)* · **LIEU-05 IMAGE 4** → 3F shot 1 (shot 2 après hard cut interne, sans start frame).
> **Ordre au montage : 3A → 3B → 3C → 3D → [3F seg. 1a + 3E + 3F seg. 1b] → 3F seg. 2.**
> ⚠ Générer DANS LE PROJET FESTIVAL. Un bloc = une génération, collée telle quelle, sans en retirer une ligne.
>
> ⚠ **REFONTE DU 31/08 — CE QUI A CHANGÉ DANS CETTE SÉQUENCE.** Le chuchotement à Milo (« Give and you shall receive » passé en secret, puis répété par l'enfant) est **SUPPRIMÉ** : 3.3 se réduit à l'échange « You're squashing me. » / « Sorry. ». Un plan NEUF entre : **3.4, Nora reçoit LA BAGUE sans un mot.** Et **3.5 devient le plan le plus important du film** : sa mère parle longuement à son père derrière une vitre, MUET. L'ancien bloc 3C (15 s, deux plans, le secret à Milo) et l'ancien 3E seg. 1 (Nora qui regarde à dix mètres) n'existent plus sous cette forme.
>
> ⚠ **POURQUOI 3.5 EST EN DEUX GÉNÉRATIONS — décision de forme, à connaître avant de lancer.**
> Le plan 3.5 dure 6 s au montage, et **la même prise doit fournir 8 s sonores en 10.10.** Une seule
> génération contenant à la fois Nora dans le couloir et la vitre ne laisserait que ~5 s de vitre :
> insuffisant. On sépare donc : **3E = LA PLAQUE** (10 s, une seule prise continue à travers la vitre,
> cadre verrouillé, muette) et **3F shot 1 = LE CONTRECHAMP** (Nora dans le couloir). Le montage de 3.5
> est : contrechamp (elle se retourne) → plaque (la vitre) → contrechamp (elle détourne les yeux et s'en
> va). **10.10 rejoue [2.0s]→[10.0s] de la MÊME plaque, voix de Maeve posée au mix.**
>
> ⚠ **LES QUATRE ÉCARTS DÉCLARÉS AUX START FRAMES** *(un écart non déclaré est un raccord perdu)*
> · **3E / LIEU-05 IMAGE 3** : la petite lampe de chevet ambre derrière la vitre **n'existe pas** dans le
>   master @HospitalRoom (jour plat froid). Écart assumé et indispensable : c'est la dernière chaleur de
>   l'acte, tenue derrière le verre, et c'est elle qui fait exister 10.10. **Elle est allumée aussi en 3C
>   et 3D, mais HORS CADRE** (derrière la tête de lit, screen-left) : aucun des deux blocs ne la montre.
> · **3D / LIEU-04 IMAGE 2** : **@MotherRing** est du set dressing vidéo — le lieu ne porte aucun objet.
>   La bague est **fermée dans le poing DROIT de Maeve dès le premier frame**, jamais vue avant l'insert.
> · **3A** : aucune start frame de lieu ; l'Élément @Kitchen porte le décor, et la lumière est **d'un cran
>   plus pâle** que dans la séq. 1 — l'or est passé au blanc-paille.
> · **3F seg. 2** : l'écharpe crimson pliée est du set dressing vidéo (garde-robe @MaeveIll). Elle
>   n'apparaît dans aucune image de lieu — il n'y a aucun rouge dans LIEU-05.
>
> ⚠ **VERROUS DE LA SÉQUENCE**
> · **VERROU DE CADRE 3B — le plus contraignant du film.** Le plan 3.2 est **rejoué au pixel** dans le
>   souvenir russe (4.3b, bloc 4E de VIDEO-SEQ-04, autre décor, autre époque). Quatre paramètres sont
>   opposables et ne se négocient pas : **Anamorphic 85 mm f/2** · **caméra à hauteur d'œil** · **la nuque
>   floue au bord GAUCHE, x=12 %, 55 % de la hauteur de cadre** · **l'homme à dix mètres, x=46 %, 55 % de
>   hauteur**, la fenêtre du fond cramée en blanc. Si l'un des quatre bouge, l'écho qui tient toute la
>   séquence 4 disparaît sans que personne ne sache pourquoi.
> · **VERROU DE PLAQUE 3E.** Une seule prise continue, aucune coupe, **aucun mouvement de caméra, le
>   cadre ne bouge pas d'un pixel.** Conserver le master intact, **jamais réencodé** : 10.10 en rejoue
>   [2.0s]→[10.0s]. **NE JAMAIS GÉNÉRER LA VOIX ICI** — elle est posée au mix, sur ces mêmes lèvres.
> · **RÈGLE A.** *Story / stories* **meurt avec Maeve** : le mot, et tout synonyme, est interdit dans
>   toute la séquence. C'est aussi pour ça que 3.4 est muet : sa mère n'a plus de mots pour personne
>   sauf pour lui — et ce qu'elle lui dit ne s'entendra qu'en 10.10.
> · **RÈGLE B.** Le seul rouge de la séquence est l'écharpe de @MaeveIll : sur ses épaules en 3C, 3D et
>   3E (mate derrière le verre), pliée sur la chaise en 3F seg. 2. **Elle sort du cadre au dernier
>   mouvement de 3F, et plus aucun rouge n'existe dans le film jusqu'à la maison rouge.**
> · **RÈGLE F.** @SamBefore est encore l'homme d'avant : **mains propres, aucune encre**, il pleure et il
>   parlerait s'il pouvait. Son silence de deux ans ne commence qu'à la fin de 10.10, pas ici.
> · **RÈGLE G.** Aucun texte lisible nulle part — ni pancarte, ni bracelet, ni fiche. Et **les lèvres de
>   Maeve en 3E ne doivent jamais être lisibles** derrière les reflets.
> · **COULEUR.** La clarté se retire plan par plan : 3A est le **dernier plan encore chaud du film**
>   (or déjà passé au paille) ; à partir de 3B tout est blanc froid, vert d'eau, gris-vert exsangue.
...
```
Storyboard sheet with 6 sequential panels in a clean grid layout, thin white borders between panels, each panel labeled only with its shot code (3A, 3B, 3C, 3D, 3E, 3F) in small letters under the panel. Cinematic live-action film previsualization: realistic human characters, consistent faces, wardrobe and locations across all panels, the warmth draining panel by panel — gold thinned to straw-white in the first panel, then pale bloodless hospital greys and sea-greens for the rest. Panel 1 ("3A"): a woman's face right of centre in three-quarter, flat and closed, her eyes down on her own raised right hand, the hand half open at chest height, pale window light on one side of her face, a worn kitchen soft behind. Panel 2 ("3B"): a hospital corridor compressed by a long lens — the blurred nape of a thirteen-year-old girl at the extreme left frame edge, and ten metres away, small and sharp, a doctor's hand resting on a man's shoulder, the man's head down, the doctor's eyes on the floor, a window blown out to white behind them. Panel 3 ("3C"): a gaunt woman propped up in a hospital bed, a deep crimson wool scarf across her shoulders over a pale-blue gown, a six-year-old boy clamped against her chest with his eyes shut, her nose lowered into his hair. Panel 4 ("3D"): a very tight two-shot at the bed rail — the gaunt mother's face and the thirteen-year-old daughter's face close together, the mother's mouth just open with nothing coming out of it, the daughter waiting, the daughter's right fist closed hard at the bottom of frame. Panel 5 ("3E"): seen from a corridor through the wired-glass window of a closed door — the mother's two hands holding her husband's face, thumbs on his cheekbones, her lips mid-word, his cheek wet in a small amber lamp's warmth, the crimson scarf muted on her shoulders, cold green reflections lying across the pane. Panel 6 ("3F"): an empty moulded plastic chair, centred, in a dim green-grey corridor — no scarf, no red, nobody. No logos, no brand names, no other text anywhere beyond the shot code labels. No red anywhere in any panel except the crimson wool scarf in panels 3, 4 and 5. Hyper-realistic cinematic film stills, true-to-life colour, film grain — NOT motion graphics, NOT an illustration, NOT concept art, no CGI look. Real photographic texture in every panel: natural depth of field, halation around practical light sources, faint noise in the shadows, film-like highlight roll-off, imperfect human framing; no oversharpening, no waxy skin, no teal-and-orange colour grade, no AI artifacts.
```
...
> ⚠ **LES QUATRE PARAMÈTRES OPPOSABLES.** 85 mm · hauteur d'œil · nuque floue à **x=12 %, 55 %** de
> hauteur, bord gauche · homme à dix mètres à **x=46 %, 55 %** de hauteur, fenêtre du fond cramée en
> blanc. Le bloc 4E de VIDEO-SEQ-04 reconstruit 4.3b sur ces quatre chiffres, dans un autre décor et une
> autre époque. **Contrôler les quatre sur le rush avant de valider.**

```
Style prompt: Flat cold hospital daylight — greener overhead fluorescent tubes doubling in the polished floor, the window at the far end of the corridor blown out to white, long-lens compression flattening ten metres of corridor, deep desaturated grey-greens, camera locked off, absolute stillness, no handheld shake. Real-time pacing, nothing hurried. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look. World-light: the brightness has left the world — cold, pallid, even hospital light, drained green-greys, bloodless and flat; no golden warmth exists anywhere here.
...
POSTURE LOCK @MaeveIll is IN THE BED, propped up on its raised head, for the entire generation — she never sits up further, never stands. @MiloBefore is ON THE BED against her right side for the entire generation — he never climbs down, never stands on the mattress. Nobody else exists in this generation at any point.
...
AUDIO The room's flat hum, the small regular tick of the monitor almost below hearing, cloth against cloth as Milo squeezes, her breath shortened by the squeeze, one long slow breath into his hair, three lines of dialogue with real silences between them. Beyond the door, the ward at a distance: a trolley passing once, a muffled two-tone chime with no words, a door sighing shut in another room. No music.
...
> ⚠ **DEUX BAGUES, NE JAMAIS LES CONFONDRE.** Sur sa main GAUCHE, avec la canule : son **alliance**, un
> anneau d'or fin, qui ne quitte JAMAIS son doigt. Dans son poing DROIT fermé, depuis le premier frame :
> **@MotherRing**, un anneau d'or fin à petite pierre pâle ronde — c'est celui qui passe. Il ne doit pas
> être visible avant l'insert. **Ne jamais faire retirer l'alliance.**
> ⚠ **LA BAGUE PREND SON POIDS ICI.** En 8.4 elle est dans un écrin de velours sur le bureau de Nora, et
> en 9.2 elle est au fond de sa poche droite, prête à être donnée à un inconnu. Si l'insert de la main
> qui se referme rate, ces deux plans-là ne paient plus rien.

```
Style prompt: Flat cold hospital daylight — a voiled north window plus overhead fluorescent, no contrast anywhere, whites and sea-greens and cold greys; the only warmth in the room is the deep crimson of a wool scarf on the mother's shoulders. Camera locked off in every shot, no handheld shake. Unhurried, naturalistic, real-time pacing — the whole scene is silent and nobody in it says one word. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look. World-light: the brightness has left the world — cold, pallid, even hospital light, drained whites and sea-greens, bloodless and flat; the scarf's crimson is the only warmth that survives.

SCENE A thirteen-year-old girl comes to her dying mother's bedside and does not know where to put her hands. Her mother takes one of them, puts a small ring into the palm, and closes the girl's fingers over it. Then she opens her mouth to speak — and nothing comes out. She has nothing left. The girl waits for words that never arrive. Three shots, two hard cuts. Nobody speaks at any point in this generation. Every second is choreographed below; nothing beyond it may be invented.
...
AUDIO The room's flat hum, the small regular tick of the monitor almost below hearing. Her steps arriving on the hard floor and stopping. Cloth on cloth, the dry slide of a hand across a stiff laundered sheet, the tiny click of gold meeting a palm at [5.2s] — the smallest sound in the film — the papery sound of fingers closed over it. At [8.1s] a breath drawn to speak, and then nothing: the mouth opens on silence. Beyond the door, the ward at a distance: a trolley passing once, a muffled two-tone chime with no words, a door sighing shut in another room. No voices anywhere. No music.
...
> ⚠ **LE PLAN LE PLUS IMPORTANT DU FILM, ET LE SEUL QUI SERT DEUX FOIS.**
> **En 3.5 il est MUET** — c'est ce que Nora voit sans l'entendre, et c'est la blessure des deux ans qui
> suivent : *sa mère avait des mots pour lui, et pas pour elle.*
> **En 10.10, LE MÊME FICHIER est rejoué de `[2.0s]` à `[8.0s]`… puis jusqu'à `[10.0s]` — 8 s — avec la
> voix de Maeve posée AU MIX.** Elle y dira : « Keep telling them your stories. It's the only thing that
> ever made them happy. » puis « Don't let her fade. Promise me. »
> **NE JAMAIS GÉNÉRER CETTE VOIX ICI.** La génération est silencieuse côté chambre, sans exception.
> ⚠ **BLOC DÉDIÉ — NE JAMAIS GROUPER.** Une seule prise continue, aucune coupe, aucun mouvement de
> caméra, le cadre ne bouge pas d'un pixel. **Conserver le master intact, jamais réencodé.**
> ⚠ **RÈGLE G** : garder son visage en trois-quarts derrière les reflets et le débit des lèvres doux —
> **jamais lisible comme des mots.** Si on peut lire sur ses lèvres, le plan est à refaire.

```
Style prompt: Seen from the corridor through the wired-glass window of a closed hospital room door — cold green fluorescent reflections sliding faintly on the glass between us and them, faint condensation at the pane's cold edges, and beyond the glass the room warmer, a small bed lamp's amber on two faces. Deep desaturated green-greys on our side. Camera locked off, absolutely still, no handheld shake, no camera movement of any kind. Not one sound of the room crosses the glass. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look. World-light: the brightness of the world has shrunk to one small place — cold, pallid green-grey on the corridor side of the glass, and beyond it only the small amber bed lamp, the last warmth of the act, held behind glass and out of reach.

SCENE Through the glass of a closed hospital room door, mute: a dying woman takes her husband's face in both her hands and speaks to him at length, without ever letting go. He cries. He nods. He tries to answer and cannot. He nods again. We hear only the corridor. One single continuous shot, locked frame, no cut, no camera movement of any kind. Every second is choreographed below; nothing beyond it may be invented.
...
POSTURE LOCK @MaeveIll is sitting up in the bed for the entire shot and never leaves it, never lies back, never lets go of his face after [1.8s]. @SamBefore is SEATED on the edge of the bed facing her, bent toward her, for the entire shot — he never stands, never turns toward the door, never wipes his face, and his hands stay on his knees from first frame to last. Nobody is in the corridor. Nobody enters or leaves.
...
> ⚠ **LE POING DROIT.** Dans tout le shot 1, la main droite de Nora est **un poing fermé le long du
> corps** — c'est la bague qu'elle vient de recevoir en 3.4. Elle ne l'ouvre jamais, elle ne la regarde
> jamais, elle ne la met dans aucune poche. **Si le poing n'est pas fermé sur le rush, la prise est à
> refaire** : c'est le seul lien visible entre 3.4 et les deux ans qui suivent.

```
Style prompt: Flat cold hospital light — the greener fluorescent tubes doubling in the polished floor, deep desaturated grey-greens, long-lens compression; in the second segment the corridor is later and dimmer, the remaining tubes the only light. Camera locked off, absolute stillness, no handheld shake. Real-time pacing, nothing hurried. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look. World-light: the brightness has left the world — cold, pallid, even hospital light, drained green-greys, bloodless and flat; in segment two dimmer still, and the folded scarf's crimson the only colour that survives.

SCENE A thirteen-year-old girl has just come out of a hospital room. A few paces down the corridor she stops, turns back, and watches something through the glass of the door she has just closed — she sees, she hears nothing, and she is not part of it. Her eyes drop. She turns and walks away without one look back, her right fist closed the whole time. Then, days later: on a corridor chair, a folded red scarf; a man's hand takes it out of frame, and the red leaves the film. Two shots, one hard cut; the cut is a scripted time jump — each segment obeys only its own LIGHT block, nothing needs to match across it. Every second is choreographed below; nothing beyond it may be invented.
...
POSTURE LOCK Segment 1: @NoraBefore is STANDING throughout, then walks out of frame — the only walking in the block, written in the FRAME MAP above; her right hand is a closed fist from the first frame to the last and never opens. Segment 2: no person is ever in frame; only the right hand and forearm of @SamBefore enter and leave. Nobody else exists in either segment.
...
AUDIO Segment 1: the corridor's flat hum, her breathing, her soft unhurried steps leaving on the polished floor and fading out of frame; far off, the hospital's day — a lift chime, a cart, a door in another wing; no voices, and NOTHING at all from behind the pane. Segment 2: near-silence — the hum, the soft slide of wool lifted off plastic, nothing else; far away, once, a door closes in another wing. No breath, no voice. No music.
