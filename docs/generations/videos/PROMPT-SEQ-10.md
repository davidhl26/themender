...
ACTION in 3 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-2.4s] START: NORA enters bottom of frame at x=48%, from directly behind, 22% h, walking away down the middle of the road; [2.4-4.8s] She stops before the house, back to camera, shoulders lifting once on a breath. [4.8-7.2s] Her right hand rises and lays flat on the board at chest height, fingers spread.
...
CAMERA — Anamorphic 40 mm f/2.8 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
...
```
MATERIALS — @video1 is the shot immediately before this one (10A). @image1 is the last frame of that shot and IT IS THE FIRST FRAME OF THIS GENERATION. @nora is NORA. @redhouseinterior is THE PLACE THIS SHOT HAPPENS IN.
...
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 28 mm f/1.4 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
...
```
MATERIALS — @video1 is the shot immediately before this one (10B). @image1 is the last frame of that shot and IT IS THE FIRST FRAME OF THIS GENERATION. @nora is NORA. @redhouseinterior is THE PLACE THIS SHOT HAPPENS IN.
...
```
MATERIALS — @video1 is the shot immediately before this one (10D-2). @image1 is the last frame of that shot and IT IS THE FIRST FRAME OF THIS GENERATION. @nora is NORA. @redhouseinterior is THE PLACE THIS SHOT HAPPENS IN.
ROLES — From the attached video take the light level and direction, the grain, the skin rendering and the way the camera behaves. TAKE NO FRAMING FROM IT beyond the first instant, and TAKE NOTHING OF ITS AUDIO: not its dialogue, not its voices, not one line spoken in it. Every line heard in it belongs to the previous shot and MUST NEVER BE HEARD AGAIN HERE. From the first-frame image take the opening composition and the exact position, pose and prop state of everything in it; take nothing else from it — no border, no backdrop, no empty-room staging, no reference layout. From NORA and the place reference take identity, face, build, wardrobe, architecture and materials exactly as the reference gives them; take none of their pose, framing, lighting or staging.
...
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 50 mm f/1.4 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
LIGHT — TWO STATES, NOTHING IN BETWEEN.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 24 mm f/2.8 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
LIGHT — STATE A · THE WINDOW LIT, THE DOOR SHUT (the arrival).
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
```
MATERIALS — @video1 is the shot immediately before this one (10F-4). @image1 is the last frame of that shot and IT IS THE FIRST FRAME OF THIS GENERATION. @sam is SAM. @BusShelter is THE PLACE THIS SHOT HAPPENS IN.
...
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 85 mm f/2 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
LIGHT — one source only: a single sodium street lamp on a column above the shelter, the column out of the top of frame, mounted SLIGHTLY FORWARD OF THE BENCH LINE toward the road, that is, slightly on the camera's side, so the hard orange cone falls from above and a little toward the lens and never from behind — this is the whole point of the lighting: the brow does not shadow the eye sockets.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
```
MATERIALS — @video1 is the shot immediately before this one (10H). @image1 is the last frame of that shot and IT IS THE FIRST FRAME OF THIS GENERATION. @sam is SAM. @nora is NORA. @mender is THE MENDER. @NoraBedroom is NORA BEDROOM, one of the places this shot happens in. @Kitchen-1 is KITCHEN, one of the places this shot happens in. @Bathroom is BATHROOM, one of the places this shot happens in.
...
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 50 mm f/2 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
...
```
MATERIALS — @video1 is the shot immediately before this one (10I). @image1 is the last frame of that shot and IT IS THE FIRST FRAME OF THIS GENERATION. @sam is SAM. @redhouseinterior is THE PLACE THIS SHOT HAPPENS IN.
ROLES — From the attached video take ONLY the film stock, the grain structure, the way skin and fabric resolve, the focus behaviour and the highlight roll-off. DO NOT TAKE its light, its palette, its exposure, its composition or its framing, and TAKE NOTHING OF ITS AUDIO: not its dialogue, not its voices, not one line spoken in it. Every line heard in it belongs to the previous shot and MUST NEVER BE HEARD AGAIN HERE. From the first-frame image take the opening composition and the exact position, pose and prop state of everything in it; take nothing else from it — no border, no backdrop, no empty-room staging, no reference layout. From SAM and the place reference take identity, face, build, wardrobe, architecture and materials exactly as the reference gives them; take none of their pose, framing, lighting or staging.
...
OPENING FRAME — Wide, camera at eye level 155 cm, 3 m back from the wall, static, locked off, the whole height of the room in frame. SAM at x=40%, filling 60% of frame height, three-quarter back;
ACTION in 3 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-2.5s] He stands facing the bare wall, hands empty; [2.5-5.1s] The brush comes off, his arm lowers, HE TAKES ONE STEP BACKWARDS and stops; [5.1-7.6s] The last white disappears under the red;
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 28 mm f/1.4 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
LIGHT — TWO STATES, NOTHING IN BETWEEN.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
INHERITED STATE, ALREADY TRUE AT FRAME ONE — SAM: centre of frame, STANDING, x=58%, filling 74% of frame height. Nothing in this list may be re-placed, re-lit or improved.
OPENING FRAME — Wide, camera at eye level 155 cm, 3 m back from the wall, static, locked off, the whole height of the room in frame. SAM at x=40%, filling 60% of frame height, three-quarter back;
ACTION in 3 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-1.5s] BROAD DAYLIGHT, the stove unlit. [1.5-3.1s] Flat grey afternoon. [3.1-4.6s] Flat grey afternoon.
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 28 mm f/1.4 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
LIGHT — TWO STATES, NOTHING IN BETWEEN.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
```
MATERIALS — @video1 is the shot immediately before this one (10I). @image1 is the last frame of that shot and IT IS THE FIRST FRAME OF THIS GENERATION. @sam is SAM. @mender is THE MENDER. @LibraryCorridor is THE PLACE THIS SHOT HAPPENS IN.
...
ACTION in 4 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-1.9s] Starting positions, held until described otherwise, all seen through the glass: MAEVE ILL sitting up, three-quarter facing camera-left at x=54% inside the pane, filling 46% of frame height, the crimson scarf over the pale-blue gown, her face turned up toward him; [1.9-3.9s] Nobody moves. [3.9-5.8s] His shoulders go once — a single shake — and the light catches wet on his cheek. [5.8-7.7s] HIS MOUTH OPENS — the jaw comes down, the lips part on a word — AND NOTHING COMES OUT.
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 50 mm f/2 equivalent. Depth of field wide open at that stop: the plane described in the ACTION stages is tack sharp and everything behind it falls off progressively.
...
```
MATERIALS — @video1 is the shot immediately before this one (10H). @image1 is the last frame of that shot and IT IS THE FIRST FRAME OF THIS GENERATION. @sam is SAM. @BusShelter is THE PLACE THIS SHOT HAPPENS IN.
ROLES — From the attached video take the light level and direction, the grain, the skin rendering and the way the camera behaves. TAKE NO FRAMING FROM IT beyond the first instant, and TAKE NOTHING OF ITS AUDIO: not its dialogue, not its voices, not one line spoken in it. Every line heard in it belongs to the previous shot and MUST NEVER BE HEARD AGAIN HERE. From the first-frame image take the opening composition and the exact position, pose and prop state of everything in it; take nothing else from it — no border, no backdrop, no empty-room staging, no reference layout. From SAM and the place reference take identity, face, build, wardrobe, architecture and materials exactly as the reference gives them; take none of their pose, framing, lighting or staging.
