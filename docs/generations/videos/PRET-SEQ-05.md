...
```
SCENE CONTEXT
The owner brings tea to a family of three she has known for years and, out of old habit, sets FOUR cups — freezes — and takes one back. Nobody says a word about it; nobody says a word at all. At the table a heavy, unshaven father cuts his son's food without ever lifting his eyes. Three shots, two hard cuts. Every second is choreographed below; nothing beyond it may be invented. 12 seconds, in 3 framings joined by 2 hard cuts.

CONTINUITY REFERENCE — SAME FILM, DIFFERENT PLACE
THE ATTACHED VIDEO (VIDEO 1) is an earlier shot from the same film (4D), IN A DIFFERENT PLACE. It is a rendering reference only. WHAT TO TAKE FROM VIDEO 1: the film stock, the grain structure, the way skin and fabric resolve, the focus behaviour, the highlight roll-off. WHAT NOT TO TAKE FROM VIDEO 1: its light, its palette, its exposure level, its composition, its framing, anything that was in its frame, and ITS AUDIO — not its dialogue, not its voices, not one line spoken in it. This shot's light comes from its own LOCATION and LIGHT paragraphs below, its framing from its own FRAME MAP. Everything else is built new, at full quality.

HANDOFF — THE EXACT STATE THIS SHOT INHERITS FROM THE ATTACHED VIDEO
These are NOT new positions to invent. This is the frame the previous shot (4D) ends on, repeated here to the number, and this generation opens with that state already true. It must CONNECT NATURALLY, NOT IDENTICALLY: match the state, the light and the camera, never chase a pixel-identical copy.
...
TEMPERAMENT, MILO Eight and the only one in the house who still says things out loud. He has not learned to be careful around grief yet, so he asks, and he keeps asking. Watchful pale grey-blue eyes that go to his sister's face before they go to anything else. He fidgets, he leans, he is always slightly too close to whoever he is talking to.
...
SUBJECT LOCK, NORA The exact person of the reference @Nora — long dark brown wavy hair, unwashed, half-tied back; grey-green eyes with a slight downward outer tilt, heavy lids with grey shadowed hollows beneath, faint freckles across the nose, chapped bitten lips, pale olive skin drained of colour, thin figure build, shoulders rounded inward. Wardrobe: the oversized faded charcoal-grey hooded sweatshirt with worn cuffs, dark indigo jeans, NO parka. Resting expression: flat, elsewhere. She never speaks in this sequence and never looks at the lens.

SUBJECT LOCK, MILO The exact person of the reference @Milo — his father's pale grey-blue eyes with long lashes, his mother's small straight nose, full childhood cheeks, faint freckles, thick dark hair with the cowlick standing at the crown; small and slight. Wardrobe: the mustard-yellow ribbed long-sleeve top, the grey-blue corduroy dungarees with one strap twisted. He eats in silence, small mouthfuls, eyes mostly on his plate — a serious, watchful @Milo. He never speaks and never looks at the lens.

SUBJECT LOCK, MEI The exact woman of the reference @Mei — Chinese American, short and sturdy, warm ivory skin dulled by decades of kitchen heat, deep laugh lines, dark brown almond eyes with a quick direct gaze; the long black hair going grey twisted up in a low bun held with the single lacquered wooden hairpin, loose strands at the temples. Wardrobe: the plain white short-sleeved cotton shirt, the long dark green cotton apron stained at the hip, the thin jade bangle on the left wrist. In this generation her eyes never cross the family's faces: she serves looking at the table, not at the people, and she never looks at @Nora. She never looks at the lens.
...
GEO — THE RESTAURANT, AFTER (night, drained grey-blue, half-empty room)
One small dining room of an old family-run Chinese restaurant in a New England port town: six formica tables on tubular chrome legs dulled and pitted at the feet, plus one small round table, each under a dark green cloth washed soft by years with its pressed fold lines showing; mismatched wooden chairs, their varnish worn pale where hands pull them out, one with a re-glued back rail; dark linoleum worn to a grey path from the door to the counter; paper lanterns in amber and brass hanging low over the tables, their paper sun-faded, one panel neatly mended; a beaded curtain to the kitchen beyond the counter, a few strands short. No red anywhere in the room, no readable lettering, no signage, no menus. EVERY FRAME SIDE BELOW IS GIVEN ON THE WORKING AXIS — eye level, from the middle of the room, looking toward the family table and the far end of the room — AND HOLDS ONLY INSIDE THE FRAMING FAMILY IT IS LISTED UNDER IN 180 AXIS. Nothing here is an absolute side.

THE STREET WINDOW — frame-left on the working axis, at the far end of the room, its roller blind half down, its pull-cord frayed, condensation creeping up the lower glass, the wet street cold and blue beyond it with sodium reflections on the asphalt. It stands behind THE FAMILY TABLE, which is the formica table nearest it.

THE FAMILY TABLE — the square formica table nearest THE STREET WINDOW, spanning the centre of frame on the working axis with the window behind it, mismatched wooden chairs around it; about 1.5 m from THE WOMEN'S ROUND TABLE — THE NEXT TABLE OVER, not a distant one.

THE WOMEN'S ROUND TABLE — the small round table under the same dark green cloth, deep and to the right on the working axis, standing against THE LACQUERED COUNTER at its far end, THE GREEN FISH TANK directly behind and above it on the wall.

THE LACQUERED COUNTER AND THE GREEN FISH TANK — the counter runs away deep along the right side of the room on the working axis, its lacquer finely crazed and rubbed to bare wood at the corner where trays slide, and it ends beside THE WOMEN'S ROUND TABLE under the green-lit fish tank — limescale tide-line at the waterline, algae creeping in the corners, a slow line of small bubbles, two dark carp. THE COUNTER'S FAR END IS BARE: no stool, no bowl, nothing standing on it, in any framing.

180 AXIS — the line joins THE FAMILY TABLE and THE WOMEN'S ROUND TABLE at the far end of the room. Every camera stands on the open-floor side of that line, away from THE STREET WINDOW, and one authored framing crosses it. Four framing families, and the sides hold inside each:
① THE ROOM AXIS — from the middle of the room toward the family table: THE STREET WINDOW frame-left behind that table, THE LACQUERED COUNTER running away deep at the extreme frame-right, THE WOMEN'S ROUND TABLE and THE GREEN FISH TANK deep at frame-right.
② THE ROUND-TABLE AXIS — from the aisle just past the family table, on the same side of the line, looking at THE WOMEN'S ROUND TABLE: that table CENTRE FRAME, THE GREEN FISH TANK filling the whole background behind it as a green field — not a rake from the right edge — THE LACQUERED COUNTER running away deep at frame-right, THE FAMILY TABLE just outside the frame's LEFT edge and THE STREET WINDOW off frame beyond it.
③ THE OVERHEAD INSERTS — straight down on the family table's cloth from about seventy centimetres above it: NO left/right relation to the room exists here. The counter, the fish tank, the street window and the round table are out of frame; the only sides are the sides of the cloth. No frame-left/frame-right given above applies to these framings.
④ THE ONE MIRRORED FRAMING — the close taken from the far side of THE FAMILY TABLE: THE STREET WINDOW falls behind the camera and is never in frame, and every landmark mirrors — THE LACQUERED COUNTER and THE GREEN FISH TANK read frame-LEFT, the tank's green spill low at the LEFT of frame. This framing and its backup are the only crossing; ① and ② never mirror.

LIGHT — the weak amber paper lanterns above each table, each pool barely a metre wide, dying into shadow between the tables with real falloff, the paper glowing unevenly where it has thinned; directly overhead on ①, ② and ③, and above-and-slightly-in-front on the close ④, leaving the eye sockets shadowed. The green of THE GREEN FISH TANK is the strongest colour in the room and it takes the side of its framing family and never contradicts it: deep frame-right, rippling faintly on the counter lacquer, on ①; filling the background behind the round table on ②; a faint cool spill reaching the far edge of the cloth on ③; low at frame-LEFT on ④. The counter light dim. The cold blue street through THE STREET WINDOW: frame-left on ①, arriving from the far end three-quarter against the camera; off frame beyond the left edge on ②; out of frame on ③; behind the camera and never in frame on ④ — no window and no cold blue behind a face in that framing. Overall a desaturated grey-blue cast, gently underexposed, deep blacks under the empty tables and in the corners; no warm key, no golden pool, and the exposure never lifts, warms or changes.

--- direction d'écran corrigée :
SCREEN DIRECTION LOCK for this scene: the 180 line joins THE FAMILY TABLE and THE WOMEN'S ROUND TABLE at the far end of the room — it is defined by the two TABLES, not by two bodies (@Mei sits at the round table only in 5B-1 and 5B-2; in 5A she serves the family table and in 5D she is at the round table in the deep background). The camera stays on the open-floor side of that line, away from the street window, in every framing. Consequence on the room axis and the round-table axis — 5A shots 1 and 3, 5B-1, 5B-2, 5D shot 1 — and it is not negotiable: @Nora holds screen-LEFT, the women's round table and everyone at it hold screen-RIGHT of her, every look @Nora sends toward that table travels screen-RIGHT, and at the round table @Asha holds screen-left of @Mei and @Fatiha screen-right of her. THE TWO OVERHEAD INSERTS ARE OUTSIDE THIS LOCK — 5A shot 2 and 5C: seen straight down, the frame is the cloth, @Sam's place at the TOP, @Milo's upper-LEFT, @Nora's at the RIGHT, the bare fourth place at the BOTTOM, hands entering from the bottom or the top edge; no screen-left/screen-right of the room applies and none may be forced onto them. ONE authored exception and no other: in 5D shot 2, and in its backup 5D-bis, the camera crosses to the far side of the family table, the street window falls behind it, and the whole direction mirrors — the empty fourth chair and the women's table lie screen-LEFT of @Nora, @Milo's side of the table lies screen-right, and @Nora's eyes travel to the LEFT of frame and nowhere else. 5A shots 1 and 3, 5B-1, 5B-2 and 5D shot 1 never mirror.

SCREEN DIRECTION LOCK for this scene: the 180 line runs between @Nora at the family table and @Mei at the women's round table, along the aisle that joins the two tables at the far end of the room. The camera stays on the door side of that line — the open-floor side, away from the street window — in every framing. Consequence, and it is not negotiable: @Nora holds screen-left in every framing, @Mei holds screen-right in every framing; at the round table @Asha holds screen-left of @Mei and @Fatiha screen-right of her; and every look @Nora sends toward the women's table travels screen-right. ONE authored exception and no other: in 5D shot 2, and in its backup 5D-bis, the camera crosses to the far side of the family table, the street window falls behind it, and the whole direction mirrors — the empty fourth chair and the women's table lie screen-LEFT of @Nora, @Milo's side of the table lies screen-right, and @Nora's eyes travel to the LEFT of frame and nowhere else. 5A, 5B-1, 5B-2 and 5D shot 1 never mirror.
...
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Sam: centre of frame, SEATED, x=58%, filling 45% of frame height. @Milo: centre of frame, SEATED, x=38%, filling 30% of frame height. @Nora: left third of frame, SEATED, x=20%, filling 50% of frame height. @Mei: centre of frame, STANDING, x=52%.
...
HANDOFF — THE EXACT STATE THIS SHOT INHERITS FROM THE ATTACHED VIDEO
These are NOT new positions to invent. This is the frame the previous shot (5A) ends on, repeated here to the number, and this generation opens with that state already true. It must CONNECT NATURALLY, NOT IDENTICALLY: match the state, the light and the camera, never chase a pixel-identical copy.
WHAT IS IN THE FRAME AT THE LAST INSTANT: The family table with exactly THREE cups steaming, the metal teapot at centre, the bare place bare, the empty chair pushed in; @Sam mid-cut over @Milo's plate, eyes down; @Milo chewing; @Nora's fork on her plate rim; @Mei's back leaving frame right with the tray and the fourth cup on it. Grey-blue room, the green tank glowing far behind, nothing at the counter's far end.
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Sam: centre of frame, SEATED, x=58%, filling 45% of frame height. @Milo: centre of frame, SEATED, x=38%, filling 30% of frame height. @Nora: left third of frame, SEATED, x=20%, filling 50% of frame height. @Mei: centre of frame, STANDING, x=52%.
Nothing in this list may be re-placed, re-lit or improved. THIS IS AN ACQUIRED STATE, NOT AN ACTION TO PLAY: whatever brought the bodies and the props here has already happened in the attached video and must NOT be performed again. This generation opens with it already true, and everything the FRAME MAP asks for happens AFTER it, never instead of it.
...
[6.55-7.05s] Half a second where nobody speaks. Nobody looks toward the family table. Nobody looks at @Nora. @Asha's eyes go from Mei to Fatiha and stay there.
...
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Asha: left third of frame, SEATED, x=27%. @Mei: centre of frame, SEATED, x=48%, filling 50% of frame height. @Fatiha: right third of frame, SEATED, x=73%, filling 55% of frame height.
...
```
SCENE CONTEXT
The same three women at the same table, still talking across each other about the same man — and then they run out of it. One of them lays her chopsticks down and says the last thing anybody has to say about him; the table goes quiet by itself for half a second; and then the oldest one asks about tea and it is over. Nothing has happened, for them. A metre and a half away, in the soft foreground, @Nora has not moved, and not one of them notices. ONE single continuous shot, no cut. Every second is choreographed below; nothing beyond it may be invented. 8 seconds, one continuous framing, no cut.

CONTINUITY REFERENCE — THIS SHOT CONTINUES THE ATTACHED VIDEO
THE ATTACHED VIDEO (VIDEO 1) is the source clip: the shot that immediately precedes this one (5B-1), in the same place and the same minute. ITS LAST FRAME IS THIS GENERATION'S BOUNDARY FRAME. ALIGN THE BOUNDARY BEFORE ANYTHING NEW HAPPENS: this clip opens on the state written under HANDOFF below — already true, nothing replayed — and only then moves on to the action the FRAME MAP gives. The boundary is meant to CONNECT NATURALLY, NOT IDENTICALLY: what must match is the state of the bodies and props, the light and the camera — not a pixel-identical image. WHAT TO TAKE FROM VIDEO 1: its light level and direction, its grain, its skin rendering, and the way its camera behaves — the same height, the same kind of movement, the same speed, the same breathing weight in the frame. WHAT NOT TO TAKE FROM VIDEO 1: its framing, and ABOVE ALL NOT ITS AUDIO — not its dialogue, not its voices, not one line spoken in it; every line heard in it belongs to the previous shot and must never be heard again here. The framing of this shot is the one the FRAME MAP gives below. Do not reset the room, do not relight it, do not change operator.

HANDOFF — THE EXACT STATE THIS SHOT INHERITS FROM THE ATTACHED VIDEO
These are NOT new positions to invent. This is the frame the previous shot (5B-1) ends on, repeated here to the number, and this generation opens with that state already true. It must CONNECT NATURALLY, NOT IDENTICALLY: match the state, the light and the camera, never chase a pixel-identical copy.
WHAT IS IN THE FRAME AT THE LAST INSTANT: The women's round table under the green tank glow, mid-meal and mid-conversation: @Fatiha drawing breath, her hands above the cloth; @Asha's eyes on Fatiha, chopsticks in her right hand; @Mei's hand still around her cup on the cloth, her chest just settling from a short laugh; in the extreme soft left foreground the back of @Nora's head and shoulder, unmoved, her fork still stopped in the air; nothing at the counter's far end.
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Asha: left third of frame, SEATED, x=27%. @Mei: centre of frame, SEATED, x=48%, filling 50% of frame height. @Fatiha: right third of frame, SEATED, x=73%, filling 55% of frame height.
Nothing in this list may be re-placed, re-lit or improved. THIS IS AN ACQUIRED STATE, NOT AN ACTION TO PLAY: whatever brought the bodies and the props here has already happened in the attached video and must NOT be performed again. This generation opens with it already true, and everything the FRAME MAP asks for happens AFTER it, never instead of it.
...
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Asha: left third of frame, SEATED, x=27%, filling 55% of frame height. @Mei: centre of frame, SEATED, x=48%, filling 50% of frame height. @Fatiha: right third of frame, SEATED, x=73%, filling 55% of frame height.
...
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Milo: centre of frame, x=48%.
...
AVOID
visible camera rigs, cartoonish colors, blurred focus, on-screen text, subtitles, captions, burned-in text, karaoke lyrics, readable menus, readable signage, readable lettering, subjects looking at camera, slow motion, morphing objects, extra people in frame, other diners, waiters, extra gestures, improvised actions, wandering hands, repositioned props, appearing or disappearing objects, camera movement, dolly, pan, zoom, push in, focus pull, handheld shake, figure looking toward the right of the frame, figure's eyes travelling right, figure looking toward figure's side of the table, figure looking across the table at her father, figure looking at any person, figure frowning, figure's face carrying a question, a window behind figure in the close shot, cold blue night behind figure in the close shot, the father lifting his eyes, the father looking at his daughter, the father looking at his son, the father speaking, a close-up of the father's face, a reverse angle on the father, the father in the close shot, figure in the close shot, the women looking toward the family table, figure speaking, figure crying, tears, trembling lips, figure looking at camera, figure eating, the fork reaching her mouth, a fourth cup at the family table, a place setting at the empty place, anyone sitting in the empty chair, anyone entering frame, anyone standing up, a stool at the counter, a bowl on a stool, anything standing at the counter's far end, rushed movements, theatrical acting, overacting, posed smiles, sitcom lighting, warm saturated grade, golden light, the room brightening, any red anywhere, red lanterns, red tablecloths, red menus, red packaging, generated music, uncanny smoothness, plastic skin, beauty filter, CGI look, video-game lighting, frozen characters, statue-like stillness, mannequin pose, freeze-frame stillness.
```
...
AVOID
visible camera rigs, cartoonish colors, blurred focus, on-screen text, subtitles, captions, burned-in text, karaoke lyrics, readable menus, readable signage, readable lettering, subjects looking at camera, slow motion, morphing objects, extra people in frame, another person in frame, the father, figure, a waitress, other diners, a reverse angle on anyone, extra gestures, improvised actions, wandering hands, repositioned props, appearing or disappearing objects, camera movement, dolly, pan, zoom, push in, focus pull, handheld shake, figure looking toward the right of the frame, figure's eyes travelling right, figure looking at any person, figure frowning, figure's face carrying a question, a window behind figure, cold blue night behind figure, figure speaking, figure crying, tears, trembling lips, figure looking at camera, figure eating, the fork reaching her mouth, a place setting at the empty place, anyone sitting in the empty chair, a stool at the counter, a bowl on a stool, rushed movements, theatrical acting, overacting, posed smiles, sitcom lighting, warm saturated grade, golden light, the room brightening, any red anywhere, red lanterns, red tablecloths, red menus, red packaging, generated music, uncanny smoothness, plastic skin, beauty filter, CGI look, video-game lighting, frozen characters, statue-like stillness, mannequin pose, freeze-frame stillness.
```
