...
```
SCENE CONTEXT
Alone at night in a dark bedroom, @Nora reads a page on her laptop, scrolls once, stops on something, and lifts her eyes off the screen toward the black window. Three shots, two hard cuts. Nothing on the screen is ever a word: the page exists as light and blocks only. Every second is choreographed below; nothing beyond it may be invented. 12 seconds, in 3 framings joined by 2 hard cuts.

CONTINUITY REFERENCE — SAME FILM, DIFFERENT PLACE
THE ATTACHED VIDEO (VIDEO 1) is an earlier shot from the same film (5D), IN A DIFFERENT PLACE. It is a rendering reference only. WHAT TO TAKE FROM VIDEO 1: the film stock, the grain structure, the way skin and fabric resolve, the focus behaviour, the highlight roll-off. WHAT NOT TO TAKE FROM VIDEO 1: its light, its palette, its exposure level, its composition, its framing, anything that was in its frame, and ITS AUDIO — not its dialogue, not its voices, not one line spoken in it. This shot's light comes from its own LOCATION and LIGHT paragraphs below, its framing from its own FRAME MAP. Everything else is built new, at full quality.

HANDOFF — THE EXACT STATE THIS SHOT INHERITS FROM THE ATTACHED VIDEO
These are NOT new positions to invent. This is the frame the previous shot (5D) ends on, repeated here to the number, and this generation opens with that state already true. It must CONNECT NATURALLY, NOT IDENTICALLY: match the state, the light and the camera, never chase a pixel-identical copy.
...
```
SCENE CONTEXT
At midnight @Nora comes out onto the rear gallery of her building, takes hold of the rail, hesitates, and throws one question out loud at the rooftops. Nothing answers. A dog barks twice, very far away. She lets go and goes back in. Two shots, one hard cut. She is the only living being on screen and nothing in the world responds to her. Every second is choreographed below; nothing beyond it may be invented. 12 seconds, in 2 framings joined by 1 hard cut.

CONTINUITY REFERENCE — SAME FILM, DIFFERENT PLACE
THE ATTACHED VIDEO (VIDEO 1) is an earlier shot from the same film (6A), IN A DIFFERENT PLACE. It is a rendering reference only. WHAT TO TAKE FROM VIDEO 1: the film stock, the grain structure, the way skin and fabric resolve, the focus behaviour, the highlight roll-off. WHAT NOT TO TAKE FROM VIDEO 1: its light, its palette, its exposure level, its composition, its framing, anything that was in its frame, and ITS AUDIO — not its dialogue, not its voices, not one line spoken in it. This shot's light comes from its own LOCATION and LIGHT paragraphs below, its framing from its own FRAME MAP. Everything else is built new, at full quality.

HANDOFF — THE EXACT STATE THIS SHOT INHERITS FROM THE ATTACHED VIDEO
These are NOT new positions to invent. This is the frame the previous shot (6A) ends on, repeated here to the number, and this generation opens with that state already true. It must CONNECT NATURALLY, NOT IDENTICALLY: match the state, the light and the camera, never chase a pixel-identical copy.
WHAT IS IN THE FRAME AT THE LAST INSTANT: Her face front-on filling the frame, lit cold blue from below, eyes lifted just past the unseen screen toward the dark window, the sodium rim in her hair, everything behind her blue-black.
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Nora: centre of frame, SEATED, x=55%, filling 58% of frame height.
Nothing in this list may be re-placed, re-lit or improved. THIS IS AN ACQUIRED STATE, NOT AN ACTION TO PLAY: whatever brought the bodies and the props here has already happened in the attached video and must NOT be performed again. This generation opens with it already true, and everything the FRAME MAP asks for happens AFTER it, never instead of it.
...
CROSS-FRAME RULES @BackGallery is the same gallery in both shots: same painted rail flaking to bare silvered wood, same peeling boards with their proud rusted nailheads, same empty sagging washing line, same receding rails of the flats below and above, same rooftops and far harbour cranes, same sodium direction from below and behind. The same @Nora in both shots, exact face and wardrobe of her reference, the same parka over the same hoodie, her hands empty throughout. The camera never moves in either shot — no pan, no tilt, no push, no drift — and never frames any lit window directly; the warm rectangle stays at the lower frame edge of the wide shot only, is never approached, never favoured, never inserted, and is simply absent from the close shot. She is the only human being in the entire generation: no figure, no silhouette and no shadow of anyone else exists anywhere, in any window, doorway, yard or reflection. The washing line is empty in every frame. Nothing red exists anywhere. Nobody looks at the lens. NO INVENTED ACTION: If a body part is not described as moving, it does not move. No gesture, step, head turn, prop interaction or expression change beyond the choreography written above; between described movements every body holds its last described position naturally (breathing, blinking, micro-sway only). CONTINUITY LOCK above and the POSITIVE CONSTRAINTS below apply in full.
...
GEO — @BackGallery, AFTER

The rear wooden gallery of a New England triple-decker: one open boarded walkway running along the back wall of the flat, open along its whole long side over back yards, leaning fences, a shed with a tarpaulin roof, shingled rooftops, the street far below and far harbour cranes. No source gives this walkway a depth or a length and none is fixed here. The galleries of the flats above and below repeat it as receding rails, the underside of the one above stained by years of drips; in the tighter framings taken along the rail those receding rails read soft in the background FRAME-RIGHT, never out over the yards.

THE PAINTED RAIL — frame-left in every framing, running the full length of the open side and away from camera on turned balusters, two of them replaced with plain sticks; grey over green over an older white, the layers curling and flaking, rubbed through to bare silvered wood along its top, rust bleeding from the brackets down the posts; its worn bare-wood patch sits at x=45% in the framings taken along the rail. The deck boards below it are split at the ends with rusted nailheads standing proud, each bleeding a dark streak, grit and dead leaves caught in the gaps.

THE FLAT DOOR — frame-right, set in the wall at the far end of the walkway, its paint chipped around the latch. In the two wides taken along the walkway it sits at x=78%; in the tighter framings along the rail it is out of frame entirely and nothing stands in for it — no door, no threshold, no lit rectangle. No source fixes its distance across the boards from THE PAINTED RAIL and none is fixed here.

THE MAILBOX — a dented sheet-metal box in flaking grey-green paint on a weather-checked grey wooden post at the head of the gallery stairs, rust blooming through the paint along the folded seams and around the loose hinge, no name plate, no number, no lettering on box or post. It is NOT a fixture of this location: it is dressed in for the séquence-7 framings only — mid-ground at x=38% in the walkway wide, centred at x=48% in the close framing on it, in both cases on the walkway between THE PAINTED RAIL and the wall and nearer camera than THE FLAT DOOR. It is absent from every séquence-6 framing, including the walkway wide, whose start image does not contain it.

THE EMPTY WASHING LINE — centre, upper frame, grey-green cord slackened and frayed between two hooks well above head height, a few wooden pegs left clipped to it, one split, no laundry on it ever. No source fixes its height above the boards or its position relative to THE FLAT DOOR, and neither is fixed here.

180 AXIS — The camera stands on the gallery itself, on THE FLAT DOOR side of THE PAINTED RAIL, which is the wall side; it never crosses to the outboard side of THE PAINTED RAIL and never turns to put the rail frame-right, and this geometry is never mirrored. It looks along the walkway in the wides and stands three-quarter to the rail in the closer framings; in both cases THE PAINTED RAIL holds frame-left.

LIGHT — One geometry by night and one by day, never mixed. AT NIGHT the only key is the sodium street lamps BELOW AND BEYOND THE PAINTED RAIL on the frame-left side, raking upward under the rail and along the boards as three-quarter back light to camera, never frontal and never from THE FLAT DOOR wall, with the cold deep blue sky, nearly black at the zenith, as a weak top fill. The kitchen window of the flat below is conditional, not constant: it lays ONE warm rectangle low across the boards at the bottom frame edge in the midnight walkway wide alone — never approached, never brightened, never favoured, never inserted; it is out of frame entirely in the framings along the rail; and in the sodium-evening walk there is no warm rectangle at all, the sodium being the only source there. BY DAY, one white overcast sky as a single huge soft source, shadowless and without direction — high and even in the morning framing, the same overcast one stop down and already going in the afternoon framing; no sodium and no orange anywhere. In both states no window of the flats above or below is ever framed lit.

---

SCREEN DIRECTION LOCK for this scene: the 180 line runs along THE PAINTED RAIL, and the camera stays on THE FLAT DOOR side of that line — the wall side — in every framing. Consequence, and it is not negotiable: THE PAINTED RAIL and the yards, rooftops and street beyond it hold screen-left in every framing; THE FLAT DOOR and the flat's wall hold screen-right in every framing; the receding rails of the flats above and below read screen-right in the tight rail framings, never screen-left. Where THE MAILBOX is dressed in, it stands on the walkway between the two, nearer camera than THE FLAT DOOR. @Nora at the rail stands with her front out over THE PAINTED RAIL — screen-left — and her body never turns to face the wall side while she is at the rail; her head is free to travel screen-left to screen-right and back along the street and the roofline wherever the choreography of a shot says so. She moves screen-left to screen-right whenever she goes toward THE FLAT DOOR, and screen-right to screen-left whenever she leaves it for the rail or the stairs. A take that comes out with the rail screen-right is mirrored: it is thrown away, never flipped in post.

SCREEN DIRECTION LOCK for this scene: the 180 line runs along THE PAINTED RAIL, and the camera stays on THE FLAT DOOR side of that line — the wall side — in every framing. Consequence, and it is not negotiable: THE PAINTED RAIL and the open yards and rooftops beyond it hold screen-left in every framing, THE FLAT DOOR and the flat's wall hold screen-right in every framing, and THE MAILBOX on its post stands between them, nearer camera than the door. @Nora at the rail faces screen-right toward nothing of the kind — she faces screen-left, out over THE PAINTED RAIL, in every framing, and never faces screen-right there; she moves screen-left to screen-right whenever she goes toward THE FLAT DOOR, and screen-right to screen-left whenever she leaves it for the rail or the stairs. A take that comes out with the rail screen-right is mirrored: it is thrown away, never flipped in post.
...
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Nora: centre of frame, STANDING, x=45%, filling 72% of frame height.
...
```
SCENE CONTEXT
At midnight, at the rail of a rear gallery, @Nora hesitates and throws one question out loud at the rooftops. Nothing answers. A dog barks twice, very far away. One single shot, no cut, tighter than the main version so that nothing in the world can enter the frame to answer her. She is the only living being on screen. Every second is choreographed below; nothing beyond it may be invented. 6 seconds, one continuous framing, no cut.
...
CROSS-FRAME RULES One continuous shot — no cut, no reframe, no camera movement of any kind. @BackGallery is the same gallery as its reference Element: same painted rail flaking to bare silvered wood, same rust-streaked brackets, same empty sagging washing line, same rooftops and back yards, same sodium direction from below and behind. The same @Nora as her reference, exact face and wardrobe, in the same parka over the same hoodie, her hands empty and on the rail throughout. She is the only human being in this generation: no figure, no silhouette and no shadow of anyone else exists anywhere, in any reflection or at any edge of frame. No window, no door and no lit rectangle is in frame at any moment. The washing line is empty in every frame. Nothing red exists anywhere. Nobody looks at the lens. NO INVENTED ACTION: If a body part is not described as moving, it does not move. No gesture, step, head turn, prop interaction or expression change beyond the choreography written above; between described movements every body holds its last described position naturally (breathing, blinking, micro-sway only). CONTINUITY LOCK above and the POSITIVE CONSTRAINTS below apply in full.
...
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Nora: centre of frame, STANDING, x=45%, filling 82% of frame height.
...
CONTINUITY REFERENCE — SAME FILM, DIFFERENT PLACE
THE ATTACHED VIDEO (VIDEO 1) is an earlier shot from the same film (6B), IN A DIFFERENT PLACE. It is a rendering reference only. WHAT TO TAKE FROM VIDEO 1: the film stock, the grain structure, the way skin and fabric resolve, the focus behaviour, the highlight roll-off. WHAT NOT TO TAKE FROM VIDEO 1: its light, its palette, its exposure level, its composition, its framing, anything that was in its frame, and ITS AUDIO — not its dialogue, not its voices, not one line spoken in it. This shot's light comes from its own LOCATION and LIGHT paragraphs below, its framing from its own FRAME MAP. Everything else is built new, at full quality.

HANDOFF — THE EXACT STATE THIS SHOT INHERITS FROM THE ATTACHED VIDEO
These are NOT new positions to invent. This is the frame the previous shot (6B) ends on, repeated here to the number, and this generation opens with that state already true. It must CONNECT NATURALLY, NOT IDENTICALLY: match the state, the light and the camera, never chase a pixel-identical copy.
WHAT IS IN THE FRAME AT THE LAST INSTANT: Her back at the gallery rail, already turning away toward the ajar door, both hands off the rail and at her sides, the empty washing line sagging above, the rooftops and the harbour cranes beyond, the warm rectangle unchanged and unremarked at the lower frame edge — nothing in the world has answered.
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Nora: centre of frame, STANDING, x=45%, filling 72% of frame height.
Nothing in this list may be re-placed, re-lit or improved. THIS IS AN ACQUIRED STATE, NOT AN ACTION TO PLAY: whatever brought the bodies and the props here has already happened in the attached video and must NOT be performed again. This generation opens with it already true, and everything the FRAME MAP asks for happens AFTER it, never instead of it.
...
WHERE THIS SHOT LEAVES EACH BODY — these are the positions the next shot inherits, whether or not the body is still inside this last frame. READ THE SPATIAL RELATION FIRST AND THE PERCENTAGE SECOND: the percentage only fixes the wording from one shot to the next, what must actually be honoured is where each body stands in relation to the room and to the other bodies: @Sam: left third of frame, STANDING, x=32%, filling 74% of frame height. @Nora: right third of frame, STANDING, x=68%.
