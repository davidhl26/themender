# PROMPTS — SÉQUENCE 02  ·  Seedance 2.0 · 1080p

> Gabarit validé en vrai sur 1B le 06/09. **C'est cette version qu'on colle.**
> Le détail complet reste dans `PRET-SEQ-02.md` (géométrie GEO, verrous, raccords).
...
| **durée** | **12 s** · **son ON** |
| **`@image1`** (start image) | LIEU-02 IMAGE 1 |
| **`@video1`** | le clip précédent |
| **Éléments** | `@sambefore` · `@maeva` · `@norabefore` · `@milobefore` · `@Quay` |

```
MATERIALS — @video1 is the shot immediately before this one (1D). @image1 IS THE FIRST FRAME OF THIS GENERATION. It is NOT the last frame of the attached video: this shot is taken from a different angle and its opening composition is the one @image1 gives. @sambefore is SAM. @maeva is MAEVE. @norabefore is NORA. @milobefore is MILO. @Quay is THE PLACE THIS SHOT HAPPENS IN.
...
SHOT — A family of four walks a quay toward dinner at sunset; an old man sits on the ground against a wall with a cardboard cup and asks for nothing; the mother stops and empties her pocket into it, smiling at him like someone already known.
...
ACTION in 3 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-3.5s] Frame contents, nobody moving through it yet: the quay in low golden sunset, stacked traps lower right, the brick wall along the left, masts in backlight across the upper half. [3.5-7.1s] MOVEMENT: MAEVE reaches into her coat pocket and turns the pocket out over the cup — coins drop in one by one, then one folded bill. [7.1-10.6s] Her mouth goes up at one corner first and the smile reaches her eyes, the way it does for someone already known.
...
CAMERA — Anamorphic 40 mm f/2.8 equivalent. CAMERA HOLD, and it is not optional: the camera stays CAMERA: wide, eye level about 160 cm, operated and breathing, carried rather than nailed down, looking along the quay into the low sun — exactly the axis of the reference master.
...
ENDING FRAME, the state this shot hands over — MAEVE standing straight over the seated man, her smile landing on his upturned, fully lit face, the coins and the folded bill in the beige cup, the crimson scarf the one line of red in the gold, NORA stopped in the background watching her mother.
...
| **format** | 21:9 · **1080p** · bitrate **high** |
| **durée** | **14 s** · **son ON** |
| **`@image1`** (start image) | LIEU-02 IMAGE 3 |
| **`@video1`** | le clip précédent |
| **Éléments** | `@sambefore` · `@maeva` · `@norabefore` · `@milobefore` · `@Quay` |

```
MATERIALS — @video1 is the shot immediately before this one (2A). @image1 IS THE FIRST FRAME OF THIS GENERATION. It is NOT the last frame of the attached video: this shot is taken from a different angle and its opening composition is the one @image1 gives. @sambefore is SAM. @maeva is MAEVE. @norabefore is NORA. @milobefore is MILO. @Quay is THE PLACE THIS SHOT HAPPENS IN.
...
INHERITED STATE, ALREADY TRUE AT FRAME ONE — SAM: centre of frame, x=60%. MAEVE: centre of frame, x=55%. NORA: right third of frame, x=80%. Nothing in this list may be re-placed, re-lit or improved.
OPENING FRAME — CAMERA: medium-close two-shot, eye level about 155 cm, operated and breathing, carried rather than nailed down, placed ahead of them on the walkway with the low sun directly behind the lens; they walk toward camera at stroll pace for the whole shot.
ACTION in 4 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-3.0s] MOVEMENT: mid-pass, SAM drops both hands from MILO's shins for half a second — a mock release, MILO dipping — and catches them again; [3.0-6.1s] She turns back to her mother and speaks, flat, half a challenge Her answer, without turning her head, worn smooth by habit [6.1-9.1s] A beat — the longest of the scene. [9.1-12.2s] Frame contents: the sunset gone, sky and wet concrete settled into an even luminous blue; MOVEMENT: the shopfront window flickers and comes alight — a warm amber halo spilling through the waved glass onto the wet concrete in a soft apron.
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 40 mm f/2.8 equivalent. CAMERA MOVE, and it is not optional: Framing 1 [0.0-10.8s] — camera: CAMERA: medium-close two-shot, eye level about 155 cm, operated and breathing, carried rather than nailed down, placed ahead of them on the walkway with the low sun directly behind the lens; they walk toward camera at stroll pace for the whole shot.
LIGHT — one source only: the low sun of the end of a clear day, a hand's width above the horizon over the open water at one end of the quay, almost horizontal, pouring warm gold straight down the walkway.
SOUND — EXACTLY 4 SPOKEN LINES IN THIS ENTIRE GENERATION, written out here and nothing else. Any other speech, any line carried over from the attached video, any murmur or half-word is an ERROR. FROM [0.0s] TO [3.4s] NOBODY SPEAKS AT ALL: no line, no word, no murmur, no breath shaped like speech. [3.4-4.6s] NORA, flat, half a challenge: "You don't even know him." [5.2-6.6s] MAEVE, not turning her head, worn smooth by habit: "Give and you shall receive." [7.3-8.2s] NORA, brows knotted: "Receive what?" [9.3-10.3s] MAEVE, unhurried, a smile in the voice: "You'll see." Nothing else is said by anyone. SFX only.
ENDING FRAME, the state this shot hands over — The lit shopfront amber in the luminous blue dusk, the family small and almost at the door with their backs three-quarter to camera, MILO up on his father's shoulders, the crimson scarf one line of red, the quay empty behind them, masts black against the last of the light.
...
CONTINUITY — ALIGN THE BOUNDARY BEFORE ANYTHING NEW HAPPENS: this clip opens on the INHERITED STATE line below exactly, everything in it already true and nothing replayed, and only then does the action begin. It must CONNECT NATURALLY, NOT IDENTICALLY.
INHERITED STATE, ALREADY TRUE AT FRAME ONE — MAEVE: centre of frame, x=44%. NORA: centre of frame, x=58%, filling 45% of frame height. Nothing in this list may be re-placed, re-lit or improved.
...
CONTINUITY — ALIGN THE BOUNDARY BEFORE ANYTHING NEW HAPPENS: this clip opens on the INHERITED STATE line below exactly, everything in it already true and nothing replayed, and only then does the action begin. It must CONNECT NATURALLY, NOT IDENTICALLY.
INHERITED STATE, ALREADY TRUE AT FRAME ONE — SAM: left third of frame, SEATED, x=26%, filling 50% of frame height. MAEVE: centre of frame, SEATED, x=44%. MILO: centre of frame, SEATED, x=60%. NORA: right third of frame, SEATED, x=76%. Nothing in this list may be re-placed, re-lit or improved.
OPENING FRAME — CAMERA: one single continuous take, no cut. A medium three-quarter across the table, lens about 60 cm above the tabletop and 1.2 m back from the paper, on the axis of the reference image.
ACTION in 4 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-3.4s] MOVEMENT: he draws on the white paper top with the wet tip — slow sure strokes, an arc, then another, then two short ticks — his forearm moving from the elbow, his shoulders low. [3.4-6.7s] MOVEMENT: the tip goes back to the cup, takes its ink of tea, and returns to the paper. NORA speaks to her mother without taking her eyes off her father's hand, quiet and matter-of-fact, the way MILO states a fact about the world [6.7-10.1s] Her look leaves her daughter, travels to her husband's bent back and hand, and stays there a beat longer than a look needs to be; MOVEMENT — THE ONLY CAMERA MOVE OF THE GENERATION: the camera withdraws in one slow straight line and decelerates to a stop, opening the frame until the four of them sit whole inside it in the amber, the emptied room soft around them, the fogged window and the blue harbour night across the upper third. [10.1-13.4s] MOVEMENT: the tip goes back to the cup, takes its ink of tea, and returns to the paper.
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 50 mm f/2 equivalent. CAMERA MOVE, and it is not optional: From [9.8s] to [13.4s] the camera withdraws ONCE — a single slow straight dolly back of about 1.2 m along the same axis, decelerating to a full stop by [13.4s] — then locked again to the end.
LIGHT — amber-and-brass paper lanterns hung low over the tables are the key: they hang above the window table and a touch beyond it toward the window, dropping soft tungsten pools straight down onto the cloth and modelling faces from above-front.
SOUND — EXACTLY 1 SPOKEN LINE IN THIS ENTIRE GENERATION, written out here and nothing else. Any other speech, any line carried over from the attached video, any murmur or half-word is an ERROR. FROM [0.0s] TO [6.2s] NOBODY SPEAKS AT ALL: no line, no word, no murmur, no breath shaped like speech. [6.2-7.9s] NORA, to her mother, without taking her eyes off her father's hand, quiet and matter-of-fact: "I love Daddy's stories." That is the only line in this generation. MAEVE does not answer. Nobody else speaks. SFX only.
ENDING FRAME, the state this shot hands over — The wider frame after the camera has stopped: the four of them at the table in the lantern amber — SAM screen-left bent over the paper, the chopstick still in his right hand; NORA screen-right leaning in on her forearms, her eyes on his hand; MAEVE facing camera with the sleeping MILO against her shoulder, her look on her husband; the abstract wet tea strokes spread across the white paper between them; the fully fogged window and the blue harbour night behind.
