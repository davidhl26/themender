...
> Lens Anamorphic **50 mm f/2** (5A, 5B-1, 5B-2, 5D) / **85 mm f/2** (5C) — la durée de chaque bloc est dans son titre.
> **Elements requis** (à charger avant de générer) : **@Sam** *(⚠ PREMIÈRE apparition du père transformé de tout le film — fiche à valider AVANT cette séquence)* · **@Nora** · **@Milo** · **@Mei** · **@Asha** · **@Fatiha** (pack §1) ·
> **@Restaurant** *(⚠ MÊME Élément que la séquence 2 — voir `docs/generations/lieux/LIEU-07-Restaurant.md`. **Ne PAS générer un deuxième restaurant « gris »** : la désaturation est portée par le style prompt de chaque bloc, jamais par un nouveau décor.)*
> La théière, les tasses, les verres d'eau, les assiettes = set dressing décrit dans les blocs, aucun Élément à générer. **Rien en [POST] dans cette séquence.**
> **Start frames** : **LIEU-07 IMAGE 2** (angle A, la table de la fenêtre) → **5A** et **5D** ·
> **LIEU-07 IMAGE 4** (angle C, la table ronde sous l'aquarium) → **5B-1** — c'est **L'AXE UNIQUE de 5.2** ·
> **5B-2** : **le DERNIER FRAME de 5B-1** (chaînage — repli : LIEU-07 IMAGE 4) ·
> **5C** : aucune start frame, l'insert est entièrement décrit au prompt.
> **Ordre au montage : 5A → 5B-1 → [5C inséré dans 5B-2] → 5B-2 → 5D.**
> ⚠ Générer DANS LE PROJET FESTIVAL. Un bloc = une génération, collée telle quelle, sans en retirer une ligne.
>
> ⚠ **CE QUI A CHANGÉ LE 31/08 — refonte demandée par David.** Les **trois récits individuels sont SUPPRIMÉS**
> (l'oignon de Fatiha, le comptoir de Mei, les vingt ans d'Asha) et **l'insert du bol sur le comptoir aussi**
> (il ne tenait que par le récit de Mei). **Les trois femmes ne racontent plus — elles se parlent entre elles,
> vite, en se coupant la parole**, et ça se termine sur « More tea? ». **41,5 s → 13 s.** Le plan n'a plus
> qu'un seul boulot : **alerter Nora.** L'ancien document décrivait huit générations (5A→5H) : **il ne reste
> que cinq blocs**, et l'ancienne nomenclature ne sert plus à rien.
>
> ⚠ **LES QUATRE ÉCARTS DÉCLARÉS AUX START FRAMES** *(à connaître avant de lancer — un écart non déclaré est un raccord perdu)*
> · **5B-1 / LIEU-07 IMAGE 4** : dans l'image de référence la table ronde est **à trois mètres** de la table
>   famille. Le script dit « à la table **d'à côté** » : elle passe à **~1,5 m**, c'est LA TABLE VOISINE.
>   L'IMAGE 4 reste la référence de décor (aquarium derrière, comptoir à droite) ; **seule la distance change**,
>   et elle est réécrite dans chaque bloc.
> · **5A et 5D / LIEU-07 IMAGE 2** : le lieu est vide. Les **trois couverts + la quatrième place NUE**, la
>   théière, les tasses et le plateau de Mei sont du **set dressing vidéo**, décrits au prompt.
> · **5B-2** : la start frame n'est pas une image de lieu mais **le dernier frame de 5B-1** — c'est ce qui fait
>   de 5.2 **un seul plan**. Si le chaînage dérive (visages, niveaux dans les tasses), repartir de LIEU-07
>   IMAGE 4 et recopier le bloc GEOMETRY en tête du prompt fautif.
> · **5C** : aucune start frame. Le raccord se fait sur deux surfaces déjà vues — **la nappe vert foncé** et
>   **la manche olive au poignet gauche déchiré** de @Sam, identiques à 5A et 5D.
>
> ⚠ **LE TABOURET ET LE BOL BLANC DU COMPTOIR SONT RETIRÉS DE TOUTE LA SÉQUENCE.** Ce n'était pas du lieu
> (LIEU-07 ne les a jamais portés) mais du **set dressing vidéo** de l'ancienne version, motivé par le seul
> récit de Mei — supprimé avec lui. Chaque bloc écrit désormais « **nothing stands at the counter's far end** ».
> **L'Élément `@CounterBowl` ne doit pas être créé** *(voir DÉPENDANCES en fin de document)*.
>
> ⚠ **VERROUS DE LA SÉQUENCE**
> · **RÈGLE ZÉRO** : **aucun raccord des yeux de Nora vers le visage de Sam, nulle part.** En 5D le plan large
>   de Sam vient **AVANT** le serré sur Nora, jamais après ; **le trajet du regard s'arrête sur la CHAISE VIDE**,
>   jamais sur son père. Elle ne relie rien, elle ne demande rien, elle ne doute pas une seconde.
> · **MEI NE REGARDE JAMAIS NORA — pas un coup d'œil.** Verrouillé quatre fois dans 5B-1 et 5B-2 : géométrie
>   (dos trois quarts à la table famille), SUBJECT LOCK, CROSS-FRAME RULES, négatifs. **Aucune des trois ne
>   s'adresse à Nora, ne la regarde, ne baisse la voix pour elle.** Elles ne savent même pas qu'elle écoute.
> · **SAM EST MUET ET NE LÈVE JAMAIS LES YEUX** (règle F) — c'est ce silence qui rend le déguisement possible.
>   Son visage est visible dans 5A et 5D (c'est @Sam, pas le SDF : la coupe à hauteur de bouche de la règle D
>   ne concerne que la séquence 9).
> · **5C — LES MAINS SEULES.** Aucun visage, aucun œil, aucun menton, aucune épaule, aucun reflet de visage
>   dans le cadre. La main s'immobilise une demi-seconde sur l'assiette de Milo, et repart au même rythme.
> · **RÈGLE A** : aucune des trois ne nomme jamais ce dont elle parle — **aucun *story*, *tale*, *legend*,
>   *myth*, nulle part.** Les trois noms — **Al-Maktoub · Msimulizi · Mòyīrén** — ne sont **JAMAIS traduits** :
>   leur traduction serait le mot interdit.
> · **RÈGLE C** : **la raison n'est PAS prononcée ici.** Elle appartient à Anna (4.5) et à elle seule.
> · **RÈGLE B** : aucun rouge nulle part — le vert de l'aquarium reste la note la plus vive du monde gris.
> · **RÈGLE E** : aucun pays, aucune ville, aucun village, aucun lieu de culte, aucun nom divin.
> · **RÈGLE G** : aucun texte lisible — menus flous, aucune enseigne, aucune écriture, aucun logo.
> · **LA LUMIÈRE NE CHANGE JAMAIS**, pas même sur le petit rire de Mei : gris sous-exposé, lanternes ambre
>   faibles, nappes vertes, aquarium vert. **La chaleur est entièrement dans les voix.**
> · **AUCUN SOUS-TITRE** : chaque NEGATIVE PROMPT porte *subtitles, captions, burned-in text, karaoke lyrics*.
>
> ⚠ **LE CŒUR DU PLAN — À NE PAS PERDRE À LA GÉNÉRATION.** « More tea? » **termine** 5.2. Pour les trois
> femmes c'est une conversation de rien, déjà oubliée ; **pour Nora, c'est une corde qu'on vient de lui jeter.**
> C'est ce décalage qui fait basculer la scène — donc **le battement de silence avant « More tea? » ne se
> taille jamais**, et **rien dans l'image ne doit désigner Nora** au moment où il tombe.
>
> ⚠ **ORDRE DE GÉNÉRATION CONSEILLÉ** : **5B-1 d'abord** — c'est le bloc qui valide l'axe unique, les trois
> visages et surtout **le débit à trois voix qui se coupent la parole**, le seul vrai risque du document.
> Puis **5B-2** (chaîné sur son dernier frame), puis **5C** (le moins cher), puis **5A**, puis **5D**.
...
```
Storyboard sheet with 5 sequential panels in a clean grid layout, thin white borders between panels, each panel labeled only with its shot code (5A, 5B-1, 5B-2, 5C, 5D) in small letters under the panel. Cinematic live-action film previsualization: realistic human characters, consistent faces, wardrobe and location across all panels, one small old family-run Chinese restaurant at night, desaturated grey-blue, gently underexposed, weak amber paper lanterns, a green-lit fish tank as the most vivid colour, cold blue night beyond a half-fogged window, deep soft shadows. Panel 1 ("5A"): the square family table under its dark green cloth with exactly THREE small white cups and a dented metal teapot, the fourth place BARE and its chair empty and pushed in; a heavy unshaven father mid-cut over a small boy's plate, eyes down; the boy chewing; a teenage girl seen from behind at the near edge; a short sturdy waitress's back leaving frame right with a black lacquered tray and one cup riding on it. Panel 2 ("5B-1"): the women's small round table one metre and a half away under the green tank glow — three seated women, an older woman in a patterned headscarf mid-word with her hand open, a tall upright woman with short locs listening, a short woman in a white shirt and dark green apron half laughing with her cup on the cloth; in the extreme soft left foreground, out of focus, the back of the teenage girl's head and shoulder, her fork stopped in the air. Panel 3 ("5B-2"): the same round table on the same axis, one beat later — the older woman's hand closed on the dented metal teapot handle, the woman in the apron giving a small nod, the tall woman's chopsticks now laid flat across her plate, all three already elsewhere; the girl's soft shoulder unmoved at the left edge, the fork still up. Panel 4 ("5C"): a tight high-angle insert of two large cracked workman's hands only — a worn-handled knife in the right, a fork in the left, stopped dead over a plate of flat noodles on a dark green cloth, olive-drab canvas sleeves with a torn left cuff entering the top of frame, a thin worn steel wedding band, fingertips faintly stained dark blue-black; NO face, no head, no shoulders, no eyes anywhere in the panel. Panel 5 ("5D"): a close on the teenage girl from the far side of her table, chest-up, shallow focus — her fork down on the plate rim, the mouthful never taken, her eyes low and to the LEFT of frame where the top rail of the empty fourth chair stands soft at the frame edge, the room behind her dissolving into weak amber pools and a low green spill. No logos, no brand names, no readable menus and no other text anywhere beyond the shot code labels. No red anywhere in any panel. Nothing on the counter's far end in any panel: no stool, no bowl. Hyper-realistic cinematic film stills, true-to-life colour, film grain — NOT motion graphics, NOT an illustration, NOT concept art, no CGI look. Real photographic texture in every panel: natural depth of field, halation around practical light sources, faint noise in the shadows, film-like highlight roll-off, imperfect human framing; no oversharpening, no waxy skin, no teal-and-orange colour grade, no AI artifacts.
```
...
```
Style prompt: The same small family restaurant as the act-one dinner, drained: a desaturated grey-blue grade over everything, the amber paper lanterns burning low and further apart, the counter light dim, the green-lit fish tank now the most vivid colour in the room, cold blue night and wet street beyond the window glass, deep soft shadows, realistic textures. Gently underexposed throughout, sparse motivated sources, deep blacks — the bleak grey world after the loss, no generous light anywhere. The light never lifts, warms, brightens or softens at any point. Camera locked off in every shot, no handheld shake. Real-time pacing. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look.

SCENE The owner brings tea to a family of three she has known for years and, out of old habit, sets FOUR cups — freezes — and takes one back. Nobody says a word about it; nobody says a word at all. At the table a heavy, unshaven father cuts his young son's food without ever lifting his eyes. Three shots, two hard cuts. Every second is choreographed below; nothing beyond it may be invented.
...
```
Style prompt: The same small family restaurant as the act-one dinner, drained: a desaturated grey-blue grade over everything, the amber paper lanterns burning low and further apart, the counter light dim, the green-lit fish tank now the most vivid colour in the room, cold blue night and wet street beyond the window glass, deep soft shadows, realistic textures. Gently underexposed throughout, sparse motivated sources, deep blacks — the bleak grey world after the loss, no generous light anywhere. THE WARMTH OF THIS SCENE IS ENTIRELY IN THE VOICES, NEVER IN THE IMAGE: the light does not lift, warm, brighten or soften at any point, not even on the small laugh. Camera locked off, no handheld shake, one single shot with no cut. Real-time pacing, but the talk itself is quick and overlapping. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look.

SCENE At the next table over, three women who have known each other for years are talking fast across each other about somebody everybody knows — not telling a story to anyone, just talking, cutting in, finishing each other's sentences. They are not performing and they are not addressing anybody outside their table. A metre and a half away, in the soft foreground, a teenage girl has stopped eating and is listening, and not one of them notices. ONE single continuous shot, no cut. Every second is choreographed below; nothing beyond it may be invented.

PERFORMANCE PACING Unhurried, naturalistic, lived-in performance throughout. Real-time pacing: every action takes the time it takes in real life, nothing is compressed or hurried. A character always finishes their action before they speak. Before every reply there is a beat of silence — the listener breathes, thinks, then answers. Dialogue at relaxed conversational speed with natural pauses inside the lines. Held looks are truly held. Documentary naturalism, warm and imperfect, never theatrical. EXCEPTION, AND IT IS THE POINT OF THIS GENERATION: these three women are old friends mid-conversation, so their lines come fast and they overlap each other by a fraction of a second at the joins written below — the bodies stay unhurried, only the talk is quick.
...
POSTURE LOCK All four characters in frame are SEATED for the entire generation; nobody rises, nobody changes seats, nobody leaves frame. @Mei never turns her head or body toward the family table. @Nora stays back three-quarter to camera and never turns her face to the lens. Her fork stays up.
...
```
Style prompt: The same small family restaurant as the act-one dinner, drained: a desaturated grey-blue grade over everything, the amber paper lanterns burning low and further apart, the counter light dim, the green-lit fish tank now the most vivid colour in the room, cold blue night and wet street beyond the window glass, deep soft shadows, realistic textures. Gently underexposed throughout, sparse motivated sources, deep blacks — the bleak grey world after the loss, no generous light anywhere. THE WARMTH OF THIS SCENE IS ENTIRELY IN THE VOICES, NEVER IN THE IMAGE: the light does not lift, warm, brighten or soften at any point. Camera locked off, no handheld shake, one single shot with no cut, on exactly the same axis and the same framing as the shot it continues. Real-time pacing, but the talk itself is quick and overlapping. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look.

SCENE The same three women at the same table, still talking across each other about the same man — and then they run out of it. One of them lays her chopsticks down and says the last thing anybody has to say about him; the table goes quiet by itself for half a second; and then the oldest one asks about tea and it is over. Nothing has happened, for them. A metre and a half away, in the soft foreground, the teenage girl has not moved, and not one of them notices. ONE single continuous shot, no cut. Every second is choreographed below; nothing beyond it may be invented.

PERFORMANCE PACING Unhurried, naturalistic, lived-in performance throughout. Real-time pacing: every action takes the time it takes in real life, nothing is compressed or hurried. A character always finishes their action before they speak. Before every reply there is a beat of silence — the listener breathes, thinks, then answers. Dialogue at relaxed conversational speed with natural pauses inside the lines. Held looks are truly held. Documentary naturalism, warm and imperfect, never theatrical. EXCEPTION, AND IT IS THE POINT OF THIS GENERATION: these three women are old friends mid-conversation, so their lines come fast and they overlap each other by a fraction of a second at the joins written below — the bodies stay unhurried, only the talk is quick. The one long silence in the middle is written and must be exactly as long as it is written.
...
AUDIO Three quick voices at the round table, overlapping, then the small wooden sound of chopsticks laid on a plate, then one flat sentence, then half a second in which the room's own noise is suddenly audible — the fish-tank pump and its bubbles, the kitchen extractor's low drone behind the beaded curtain, the drinks cooler cycling, wet tyres passing outside — and then an ordinary question and a hand closing on a metal handle. At the family table, off frame left, nothing but the slow scrape of a knife on china, faint, unbroken, all the way through. No music.
...
```
Style prompt: A tight insert on a table in the same small family restaurant, drained: a desaturated grey-blue grade over everything, a weak amber lantern pool falling from above onto a dark green tablecloth, the green of a fish tank reaching the far edge of frame as a faint cool spill, deep soft shadows, realistic textures. Gently underexposed, sparse motivated sources, deep blacks. Camera locked off, no handheld shake, one single shot with no cut, shallow depth of field. Real-time pacing. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look.

SCENE Two large workman's hands cut a child's food, slowly and evenly, the way they have all evening. A woman's voice says something across the room, off screen — and the hands stop dead, mid-cut, for half a second. Then they start again at exactly the same rhythm, as if nothing had happened. ONE single continuous shot, no cut. NOTHING ABOVE THE FOREARMS IS EVER IN FRAME: no face, no head, no shoulders, no chin, no eyes, no reflection of a face, at any point. Every second is choreographed below; nothing beyond it may be invented.

PERFORMANCE PACING Unhurried, naturalistic, lived-in performance throughout. Real-time pacing: every action takes the time it takes in real life, nothing is compressed or hurried. A character always finishes their action before they speak. Before every reply there is a beat of silence — the listener breathes, thinks, then answers. Dialogue at relaxed conversational speed with natural pauses inside the lines. Held looks are truly held. Documentary naturalism, warm and imperfect, never theatrical.

NATURAL MICRO-MOVEMENT Nobody is ever frozen, not for a single frame. Between and during the written actions, every character carries constant, very slow, very human micro-movement: breath visibly lifting the chest and shoulders, soft weight shifts of a few millimetres, small head drifts of a degree or two, fingers settling and resettling, eyes travelling a few millimetres and returning, blinks at natural intervals. This micro-life never adds gestures, steps, props or expressions — it is simply how a living body holds a position. Always slow and organic, never fidgety, never twitchy; no statue stillness, no freeze-frame, no mannequin pose. IN THIS GENERATION the only body in frame is a pair of forearms and hands: during the written half-second stop they hold absolutely still except for the faintest breath moving the canvas sleeve and the smallest settle of one fingertip on the knife handle — the stop is a held human stillness, not a frozen image, and the film grain, the steam and the light keep living around it.
...
POSTURE LOCK Only @Sam's two forearms and hands exist in this generation, entering from the top of frame, working over the plate for the whole shot. He is SEATED off frame and never rises. He never speaks. Nothing above the forearms is ever in frame.
...
```
Style prompt: The same small family restaurant as the act-one dinner, drained: a desaturated grey-blue grade over everything, the amber paper lanterns burning low and further apart, the counter light dim, the green-lit fish tank now the most vivid colour in the room, cold blue night and wet street beyond the window glass, deep soft shadows, realistic textures. Gently underexposed throughout, sparse motivated sources, deep blacks — the bleak grey world after the loss, no generous light anywhere. In the second shot a shallow depth of field lets the room dissolve into soft amber and green shapes behind the girl's face. Camera locked off in both shots, no handheld shake. Real-time pacing, and nobody speaks anywhere in this generation. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look.

SCENE First, the family table, wide and silent: a heavy unshaven father cutting his young son's food, eyes down, cutting, cutting — on screen, a busy father and nothing else. Then the camera crosses to the far side of the table and holds close on the teenage girl: her fork still stopped in the air, the mouthful never taken; her eyes come back from the women's table across the room and settle on the empty chair at her own table, and stop there. She puts the fork down without having eaten. She asks nobody anything. Two shots, one hard cut. Every second is choreographed below; nothing beyond it may be invented.

PERFORMANCE PACING Unhurried, naturalistic, lived-in performance throughout. Real-time pacing: every action takes the time it takes in real life, nothing is compressed or hurried. A character always finishes their action before they speak. Before every reply there is a beat of silence — the listener breathes, thinks, then answers. Dialogue at relaxed conversational speed with natural pauses inside the lines. Held looks are truly held. Documentary naturalism, warm and imperfect, never theatrical. Nobody speaks anywhere in this generation.
...
POSTURE LOCK @Sam, @Nora and @Milo are SEATED for the entire generation and never rise; the three women in the background are SEATED and never rise. Nobody sits in the empty fourth chair, nobody touches it. @Sam's hands hold the knife and fork over @Milo's plate for the whole generation and HE NEVER LIFTS HIS EYES, not once, not for a single frame.
...
```
Style prompt: A close shot inside the same small family restaurant, drained: a desaturated grey-blue grade over everything, one weak amber paper lantern above and slightly in front of the girl, the room behind her dissolving into soft amber patches and a low green spill from a fish tank at the left of frame, cold blue night far behind camera and never seen, deep soft shadows. Gently underexposed, sparse motivated sources, deep blacks. Shallow depth of field. Camera locked off, no handheld shake, one single shot with no cut. Real-time pacing, and nobody speaks. Hyper-realistic live-action footage, indistinguishable from film shot on a real set with real actors: true skin texture with visible pores and fine hairs, real fabric weave, seams and wrinkles that crease with movement, natural motion blur, constant micro-life in every held position (breathing, blinking, weight shifts of a few millimetres), only motivated practical light, subtle film grain, true-to-life colour. NOT CGI, NOT animation, no uncanny smoothness, no plastic skin, no beauty retouching, no video-game look.

SCENE A teenage girl alone in the frame at a restaurant table, her fork stopped in the air, the mouthful never taken. Her eyes come back from something far to her left and settle on something near, low and still to her left — a metre from her hand — and stop there. She puts the fork down without having eaten. She says nothing and she asks nobody anything. ONE single continuous shot, no cut, nobody else in frame at any point. Every second is choreographed below; nothing beyond it may be invented.

PERFORMANCE PACING Unhurried, naturalistic, lived-in performance throughout. Real-time pacing: every action takes the time it takes in real life, nothing is compressed or hurried. A character always finishes their action before they speak. Before every reply there is a beat of silence — the listener breathes, thinks, then answers. Dialogue at relaxed conversational speed with natural pauses inside the lines. Held looks are truly held. Documentary naturalism, warm and imperfect, never theatrical. Nobody speaks in this generation.
...
POSTURE LOCK @Nora is SEATED for the entire generation and never rises, never turns her body, never leans. Nobody else exists in this generation at any point.
