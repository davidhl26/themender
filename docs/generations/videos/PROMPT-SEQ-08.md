# PROMPTS — SÉQUENCE 08  ·  Seedance 2.0 · 1080p

> Gabarit validé en vrai sur 1B le 06/09. **C'est cette version qu'on colle.**
> Le détail complet reste dans `PRET-SEQ-08.md` (géométrie GEO, verrous, raccords).
...
INHERITED STATE, ALREADY TRUE AT FRAME ONE — NORA: centre of frame, LYING, x=52%, filling 60% of frame height. Nothing in this list may be re-placed, re-lit or improved.
...
ACTION in 4 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-2.4s] THE SOUND — a dry riffle of pages turning somewhere down the shelves, with no one to turn them. Her head comes up slowly and turns toward the corridor screen-right, breath held, shoulders unmoved. [2.4-4.8s] THE COAT IS ALREADY IN THE FRAME AND ALREADY MOVING, large and unmistakable — no entrance, no start-up: at x=52%, filling 62% of frame height, a tall figure seen from DIRECTLY BEHIND, mid-stride, crossing the gap between two shelf ranges from screen-left to screen-right, hard against the window's backlight. [4.8-7.3s] OFF SCREEN, behind camera: a chair goes over backwards and cracks on the parquet, then fast running steps. The aisle, empty end to end: nobody, nothing moving, the weak grey spill sliding in around the corner, dust settling through it. [7.3-9.7s] NORA swings into the near frame edge from screen-left, SEEN FROM BEHIND AND THREE-QUARTER BACK, her left hand catching the shelf upright, and stops dead — no face to camera.
...
CAMERA — Anamorphic 50 mm f/2 equivalent. CAMERA HOLD, and it is not optional: the camera stays Medium across the study table, seated eye level, camera about 115 cm high and 1.5 m from the table at a slight three-quarter angle, static, locked off.
...
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 40 mm f/2 equivalent, one stop wider than 8A. CAMERA HOLD, and it is not optional: the camera stays Wide straight down the corridor of shelves, eye level about 155 cm, deep focus, static, locked off, one stop wider than the main version — the shelves closing in toward the bright window rectangle at the far end, exactly the axis of the reference master, the whole height of a standing figure held inside the frame with air above the hood.
LIGHT — One source only: the window at the far end of the corridor, throwing flat cold late-afternoon light straight down its length — a grey-white shaft with dust hanging almost motionless in it, the beam's edges feathered, laying a long dull gleam up the centre of the parquet and a bright rectangle on the floor at the end.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
OPENING FRAME — Static, camera at 160 cm on the landing, looking down the full length of the dark hallway, exactly the axis of the reference angle: her bedroom door screen-right at x=68%, ajar ten centimetres, the blade of cold light from the gap lying across the boards toward camera; the hallway running away to the far corner at x=22%, where a thin thread of sodium orange grazes the wall and the top of the stair rail post shows at x=15%; near-black everywhere else.
ACTION in 3 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-3.0s] The bedroom door swings quietly inward and widens; THE GLIMPSE, and it is over before it is understood: at the far corner, LOW IN THE FRAME, the HEM AND LOWER BACK of a long dark coat — nothing above hip height, no shoulders, no head, no hand — slide once from x=26% out past the corner toward the unseen stairs and are gone. [3.0-6.0s] Her left hand comes off the handle and drops to her side. [6.0-9.0s] She crosses the last two metres in two slow barefoot steps, the glass hanging at her side, and stops at the corner, her free hand coming to rest on the rail post.
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 50 mm f/2 equivalent. CAMERA HOLD, and it is not optional: the camera stays Static, camera at 160 cm on the landing, looking down the full length of the dark hallway, exactly the axis of the reference angle: her bedroom door screen-right at x=68%, ajar ten centimetres, the blade of cold light from the gap lying across the boards toward camera; the hallway running away to the far corner at x=22%, where a thin thread of sodium orange grazes the wall and the top of the stair rail post shows at x=15%; near-black everywhere else.
LIGHT — motivated sources only, never more than two lit at once, and the two temperatures never mix.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
ENDING FRAME, the state this shot hands over — NORA alone at the dark corner of the landing, seen from behind, chest-up, looking down into the black stairwell, the empty glass hanging at her side, one hand on the rail post, the thread of sodium grazing her shoulder; the hallway empty behind her, her bedroom door ajar at the far frame edge.
...
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 50 mm f/2 equivalent. CAMERA HOLD, and it is not optional: the camera stays Static, camera at 160 cm, two metres from the corner of the landing and square to the corner wall, locked off: the corner and the stair rail's top post filling the right half of frame, the wall running away to the left, the black drop of the unseen stairwell opening beyond the post, near-black everywhere except where the sodium thread grazes the wall.
LIGHT — motivated sources only, never more than two lit at once, and the two temperatures never mix.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
CONTINUITY — ALIGN THE BOUNDARY BEFORE ANYTHING NEW HAPPENS: this clip opens on the INHERITED STATE line below exactly, everything in it already true and nothing replayed, and only then does the action begin. It must CONNECT NATURALLY, NOT IDENTICALLY.
INHERITED STATE, ALREADY TRUE AT FRAME ONE — NORA: centre of frame, STANDING, x=62%, filling 62% of frame height. Nothing in this list may be re-placed, re-lit or improved.
...
ACTION in 4 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-2.3s] Frame contents: the steam-filled room, the mirror at x=65% fogged across its LOWER THIRD only, clear glass above it; She lifts her eyes to the mirror out of habit, without interest — and the raised hand STOPS exactly where it is, the towel's edge held in mid-air. [2.3-4.6s] THE SWEEP: the fog front rises evenly across the full width of the glass, a single soft even wave, and as it passes it UNCOVERS the middle band, then the upper band — the bands are not drawn, not traced, not written: the opacity closes around them and leaves them clear. [4.6-6.9s] The fog is now complete, edge to edge, and the three clear bands stand in it, whole, sharp and still, held wide and steady for the rest of the shot — no change of shape, no growth, no drift, no drop crossing them. [6.9-9.2s] She takes one step backwards, off balance, and her shoulder blades hit the door — a flat dull knock; Her right arm comes up and reaches across;
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 85 mm f/2 equivalent. CAMERA HOLD, and it is not optional: the camera stays Medium chest-up from the doorway, angled toward the mirror and basin, eye level, static, locked off — exactly the axis of the reference angle: the mirror screen-right at x=65%, the basin below it, the shower curtain and the towel radiator at the frame edges.
...
ACTION in 3 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-1.5s] Nothing on the mirror changes for one frame: the three bands hold their shapes, lengths and positions absolutely, the fog holds its opacity, no stroke extends, no mark is added, nothing writes itself. Frame contents, unmoving: the glass fogged edge to edge. [1.5-2.9s] Nothing on the mirror changes for one frame: the three bands hold their shapes, lengths and positions absolutely, the fog holds its opacity, no stroke extends, no mark is added, nothing writes itself. [2.9-4.4s] Two beads gather at the OUTER END of the lower band, at its far right tip, and begin to run — slowly, a few millimetres, blurring that far tip only.
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 85 mm f/2 equivalent. CAMERA HOLD, and it is not optional: the camera stays Macro insert on the mirror alone, 85 mm, camera square to the glass at about 60 cm, static, locked off: the fogged mirror filling the frame, its chipped enamel edge entering the left and right frame edges, the chipped top of the basin crossing the bottom of frame.
LIGHT — one practical: the single wall light above THE MIRROR, diffused by the vapour, the bulb wearing a soft halo in the steam, its throw dying within a metre, laying whites and cold greys on the tiles.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
CONTINUITY — ALIGN THE BOUNDARY BEFORE ANYTHING NEW HAPPENS: this clip opens on the INHERITED STATE line below exactly, everything in it already true and nothing replayed, and only then does the action begin. It must CONNECT NATURALLY, NOT IDENTICALLY.
INHERITED STATE, ALREADY TRUE AT FRAME ONE — NORA: centre of frame, STANDING, x=62%. Nothing in this list may be re-placed, re-lit or improved.
...
ACTION in 3 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-2.4s] Her hands come into frame from the lower edge without hurry; Inside: the thin gold ring, a plain worn band with no stone and nothing set into it, macro-sharp, the cold lamp light finding the brighter inner curve of the worn gold and one small warm point where the sodium reaches it — the only warm glint in this world. [2.4-4.8s] The closed fist lowers out of the bottom of frame and does not come back. Her closed right fist slides into the parka's RIGHT side pocket — the nylon lifting and creasing around her wrist — and stays there half a second. [4.8-7.2s] Her left hand reaches to the clip lamp and clicks the switch.
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 85 mm f/2 equivalent. CAMERA HOLD, and it is not optional: the camera stays Macro on her hands and the box, high angle over the desk, camera about 50 cm above the wood, tilted down at roughly 60 degrees, static, locked off, very shallow focus.
LIGHT — motivated sources only, never more than two lit at once, and the two temperatures never mix.
SOUND — NOBODY SPEAKS IN THIS ENTIRE GENERATION: not one line, not one word, not one murmur, and NO LINE IS CARRIED OVER FROM THE ATTACHED VIDEO. SFX only.
...
CONTINUITY — ALIGN THE BOUNDARY BEFORE ANYTHING NEW HAPPENS: this clip opens on the INHERITED STATE line below exactly, everything in it already true and nothing replayed, and only then does the action begin. It must CONNECT NATURALLY, NOT IDENTICALLY.
INHERITED STATE, ALREADY TRUE AT FRAME ONE — NORA: centre of frame, STANDING, x=52%, filling 66% of frame height. Nothing in this list may be re-placed, re-lit or improved.
...
ACTION in 4 stages, timings are budgets not edit points, each stage ends on the state the next one starts from — [0.0-2.8s] The city slides: two slow sodium-orange passes cross her face and die. The engine note falls, the bus slows; [2.8-5.5s] Behind her the passes are now cold shopfront neon, blue-white and green-white, sliding across the fogged glass instead of sodium. The engine note falls; [5.5-8.2s] Outside, the passes have grown rare — long black gaps between them, the city fraying, one lamp every few seconds. The engine note falls a third time. [8.2-11.0s] She stands in ONE movement, without hurry and without hesitation — and in the same movement the crumpled packet is lifted off her lap and pushed down into the parka's RIGHT side pocket, where it settles and bulges.
PERFORMANCE — Nobody performs an emotion here. The feeling is legible only through the exact physical events written in the ACTION stages above, and through nothing else: no added expression, no widened eyes, no trembling lip, no theatrical breath.
CAMERA — Anamorphic 50 mm f/2 equivalent. CAMERA HOLD, and it is not optional: the camera stays Close-up, right profile, seated eye level about 110 cm, camera locked to the bus a metre from her, static framing, the fogged window filling the frame behind her.
